...
2. Subscribe to the latest Dash/Zeal docs by clicking 
   `dash-feed://http%3A%2F%2Fpymatgen.org%2Fpymatgen.xml 
   <dash-feed://http%3A%2F%2Fpymatgen.org%2Fpymatgen.xml>`_. 
   You should have the MacOS `Dash app <http://kapeli.com/dash>`_ or Windows 
   `Zeal app <http://zealdocs.org/>`_ installed.
