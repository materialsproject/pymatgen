...
if __name__ == '__main__':
    ...
    while True:
        ...
        cg_symbol = input('Enter symbol of the geometry for which you want to get the optimized permutations '
                          'or "q" to quit : ')
        if cg_symbol == 'q':
            break
        ...
        while True:
            test = input('Get the explicit optimized permutations for geometry "{}" (symbol : "{}") ? '
