...
static PyMethodDef functions[] = {
  ...
  {"multiplicity", get_multiplicity, METH_VARARGS,
						   ...
						   PyObject *args)
{
  ...
  if (!PyArg_ParseTuple(args, "OOOOOOd", &rotation, &translation,
			&lattice, &position, &atom_type, &magmom,
			&symprec)) {
    return NULL;
  }
  ...
  /* num_sym has to be larger than num_sym_from_array_size. */
  const int num_sym = 
    spg_get_symmetry_with_collinear_spin(rot,
					 trans,
					 num_sym_from_array_size,
					 lat,
					 pos,
