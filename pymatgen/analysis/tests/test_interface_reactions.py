...
class InterfaceReactionTest(unittest.TestCase):
    ...
    def test_get_grand_potential(self):
        ...
        self.assertTrue(test3, "_get_grand_potential: " "get hull energy gets error!")
    ...
    def test_get_energy(self):
        ...
        self.assertTrue(test4, "_get_energy: gets error. ")

    def test_get_reaction(self):
        test1 = str(self.ir[0]._get_reaction(0.5)) == "0.5 O2 + 0.5 Mn -> " "0.5 MnO2"
        self.assertTrue(
            test1,
    ...
    def test_get_critical_original_kink_ratio(self):
        ...
        self.assertTrue(test1, "get_critical_original_kink_ratio:" " gets error!")
        test2 = np.allclose(self.ir[10].get_critical_original_kink_ratio(), [0, 0.5, 1])
        self.assertTrue(test2, "get_critical_original_kink_ratio:" " gets error!")
    ...
    def test_labels(self):
        ...
        test1 = dict == {
            ...
            2: "x= 0.5 energy in eV/atom = -15.0 0.5 O2 + 0.5 " "Mn -> 0.5 MnO2",
