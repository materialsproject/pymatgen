...
class EwaldSummationTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertAlmostEqual(ham.real_space_energy, -503.18761981526637, 4)
        self.assertAlmostEqual(ham.reciprocal_space_energy, 6.0854878939547437, 4)
        self.assertAlmostEqual(ham.point_energy, -620.86117622153745, 4)
        self.assertAlmostEqual(ham.total_energy, -1117.9633081428492, 2)
        ...
        self.assertAlmostEqual(sum(sum(ham.real_space_energy_matrix)),
                               -503.18761981526637, 4)
        self.assertAlmostEqual(sum(sum(ham.reciprocal_space_energy_matrix)),
                               6.0854878939547437, 4)
        self.assertAlmostEqual(sum(ham.point_energy_matrix), -620.86117622153745,
                               4)
        self.assertAlmostEqual(sum(sum(ham.total_energy_matrix)),
                               -1117.9633081428492, 2)
        ...
        self.assertAlmostEqual(ham2.real_space_energy, -503.18761981526637, 4)
