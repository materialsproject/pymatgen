...
from pymatgen.analysis.disorder import compute_warren_cowley_parameters
...
class OrderParameterTest(PymatgenTest):
    def test_compute_warren_cowley_parameters(self):
        ...
        aij = compute_warren_cowley_parameters(s, r=3.4, dr=0.3)
        print(aij)
        self.assertAlmostEqual(aij[(Element.Mo, Element.W)], -1.0)
        aij = compute_warren_cowley_parameters(s, r=4, dr=0.2)
