...
class ReactionTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEquals(str(rxn), "2.000 Fe + 1.500 O2 -> 1.000 Fe2O3",
                          "Wrong reaction obtained!")
        self.assertEquals(rxn.normalized_repr, "4 Fe + 3 O2 -> 2 Fe2O3",
        ...
        rxn = Reaction(reactants, products)
        self.assertEquals(str(rxn), "2.000 TiO2 -> 2.000 TiO2",
                          "Wrong reaction obtained!")

        reactants = [Composition("FePO4"), Composition("Li")]
        products = [Composition("LiFePO4")]
        rxn = Reaction(reactants, products)
        self.assertEquals(str(rxn), "1.000 FePO4 + 1.000 Li -> 1.000 LiFePO4",
                          "Wrong reaction obtained!")
        ...
        rxn = Reaction(reactants, products)
        self.assertEquals(str(rxn), "1.000 MgO -> 1.000 MgO",
                          "Wrong reaction obtained!")
        ...
        rxn = Reaction(reactants, products)
        self.assertEquals(str(rxn), "1.000 Mg -> 1.000 Mg",
                          "Wrong reaction obtained!")
    ...
    def test_normalize_to(self):
        ...
        self.assertEquals(str(rxn), "1.500 Fe2O3 -> 3.000 Fe + 2.250 O2",
                          "Wrong reaction obtained!")
    ...
    def test_calculate_energy(self):
        ...
        self.assertEquals(rxn.normalized_repr, "MgO + Al2O3 -> MgAl2O4")
