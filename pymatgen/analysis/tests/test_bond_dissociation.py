...
class BondDissociationTest(unittest.TestCase):
    def setUp(self):
        ...
        self.PC_65_principle = loadfn(os.path.join(module_dir, "PC_65_principle.json.gz"))
        ...
        self.PC_65_fragments = loadfn(os.path.join(module_dir, "PC_65_fragments.json.gz"))
        ...
        self.neg_EC_40_principle = loadfn(os.path.join(module_dir, "neg_EC_40_principle.json.gz"))
        ...
        self.neg_EC_40_fragments = loadfn(os.path.join(module_dir, "neg_EC_40_fragments.json.gz"))
        ...
        self.neg_TFSI_principle = loadfn(os.path.join(module_dir, "neg_TFSI_principle.json.gz"))
        ...
        self.neg_TFSI_fragments = loadfn(os.path.join(module_dir, "neg_TFSI_fragments.json.gz"))
