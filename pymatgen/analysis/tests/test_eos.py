...
class EOSTest(unittest.TestCase):
    ...
    def test_numerical_eoswrapper(self):
        ...
        self.assertAlmostEqual(numerical_eos.e0, self.num_eos_fit.e0, 3)
        self.assertAlmostEqual(numerical_eos.v0, self.num_eos_fit.v0, 3)
        self.assertAlmostEqual(numerical_eos.b0, self.num_eos_fit.b0, 3)
        self.assertAlmostEqual(numerical_eos.b1, self.num_eos_fit.b1, 3)
