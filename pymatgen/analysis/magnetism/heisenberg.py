...
class HeisenbergMapper:
    ...
    def get_heisenberg_model(self):
        ...
        hmodel = HeisenbergModel(hm_formula, hm_structures, hm_energies, hm_cutoff, hm_tol, hm_sgraphs, hm_usi, hm_wids, hm_nni, hm_d, hm_em, hm_ep, hm_igraph)
...
class HeisenbergModel(MSONable):
    def __init__(self, formula=None, structures=None, energies=None, cutoff=None, tol=None, sgraphs=None, unique_site_ids=None, wyckoff_ids=None, nn_interactions=None, dists=None, ex_mat=None, ex_params=None, igraph=None):
        """
        Store a Heisenberg model representation of low-energy magnetic orderings. Intended to be generated by HeisenbergMapper.get_heisenberg_model(). 

        NOTE: This class has attributes that are dictionaries with integer keys (not strings) because the keys are used as site indexes. For this reason, the HeisenbergModel can only be saved as a .yaml (e.g. with dumpfn(heisenberg_model_instance, 'hmodel.yaml')) and NOT as a .json file.
