...
#             print(4, operations[i][0], operations[i][1], operations[i][2], operations[i][3])
...
#         print(5, operations[i][0], operations[i][1])
    ...
    def get_stable_fcm(fcm, struc, operations, sharedops, asum = 10):
        ...
        while check == 0:
            ...
            fcm = get_symmetrized_FCM(fcm, operations, sharedops)
    ...
    def get_fullfcm(struc, fcm, force = 1, asum = 10):    
        ...
        fcm  = get_new_FCM(struc, sharedops, operations, force)
