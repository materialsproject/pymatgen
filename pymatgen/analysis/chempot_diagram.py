...
class ChemicalPotentialDiagram(MSONable):
    ...
    def _get_domains(self):
        """ Returns a dictionary of domains as {formula: np.array}"""
    ...
    def _get_border_hyperplanes(self) -> np.array:
    ...
    def _get_hyperplanes_and_entries(self) -> Tuple[np.array, List[PDEntry]]:
    ...
    def _get_2d_plot(self, elements: List[Element],
                     label_stable: Optional[bool]) -> Figure:
    ...
    @staticmethod
    def _get_3d_domain_simplexes_and_ann_loc(points_3d) -> Tuple[List[Simplex], np.array]:
    ...
    @staticmethod
    def _get_min_entries_and_el_refs(entries) -> Tuple[List[PDEntry], Dict[Element, PDEntry]]:
