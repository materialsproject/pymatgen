...
class CoherentInterfaceBuilder:
    ...
    def _find_matches(self) -> None:
        ...
        film_slab = film_sg._get_slab(shift=0)
        sub_slab = sub_sg._get_slab(shift=0)
    ...
    def get_interfaces(
        ...
        film_slab = film_sg._get_slab(shift=film_shift)
        sub_slab = sub_sg._get_slab(shift=sub_shift)
