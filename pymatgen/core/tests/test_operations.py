...
class SymmOpTestCase(unittest.TestCase):
    ...
    def test_properties(self):
        ...
        self.assertTrue((abs(rot - np.array([[0.8660254, -0.5, 0.],
                                             [0.5, 0.8660254, 0.],
                                             [0., 0., 1.]])) < 0.01).all())
    ...
    def test_operate(self):
        ...
        self.assertTrue((abs(newcoord -
                             np.array([-0.1339746, 2.23205081, 4.])) < 0.01)
                        .all())
    ...
    def test_apply_rotation_only(self):
        ...
        self.assertTrue((abs(rotate_only - newcoord +
                             self.op.translation_vector) < 0.01).all())
