...
0.000 0.000 10.000""",
    ...
    def test_get_lattice_coords(self):
       ...
       self.assertArrayAlmostEqual(lattice.get_lattice_coords(cart_coord), latt_coord)
       self.assertArrayEqual(lattice.get_lattice_coords(cart_coord).shape, [3,])
       self.assertArrayEqual(lattice.get_lattice_coords(cart_coord.reshape([1,3])).shape, [1,3])
