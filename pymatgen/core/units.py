"""
Unit conversion tools. These functions are defined here instead of core.physical_constants 
because we have to import and inspect the attributes of the module.
"""
