...
This module implements classes for processing Lammps output files:
    ...
    2. trajectory file(dump file): the file generated by the 'dump' command
        Assumptions: The first 2 fields must be the atom id and the atom type.
            There can be arbitrary number of fields after that and they all
            will be treated as floats and updated based on the field names in
            the ITEM: ATOMS line
"""
