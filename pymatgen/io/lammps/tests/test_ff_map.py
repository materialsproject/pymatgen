...
class TestLammpsForceFieldData(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.tatoms = [['C', 'C3'], ['H', 'H3'], ['H', 'H3'], ['H', 'H3'], ['O', 'O'],
                    ...
                    ['H', 'H3']]
        cls.tbonds = [[0, 1, ('C3', 'H3')], [0, 2, ('C3', 'H3')], [0, 3, ('C3', 'H3')],
        ...
        cls.tangles = [[1, 0, 2, ('H3', 'C3', 'H3')], [1, 0, 3, ('H3', 'C3', 'H3')],
        ...
        cls.tdihedrals = [[1, 0, 4, 5, ('H3', 'C3', 'O', 'C2')], [2, 0, 4, 5, ('H3', 'C3', 'O', 'C2')], [3, 0, 4, 5, ('H3', 'C3', 'O', 'C2')],
        ...
        cls.forcefield = ForceField.from_file("ffmap_data.yaml")
