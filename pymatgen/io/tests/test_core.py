...
class TestInputFile(PymatgenTest):
    def test_file_io(self):
        ...
        sif = StructInputFile.from_file(os.path.join(test_dir, "Li.cif.gz"))
...
class TestInputSet(PymatgenTest):
    @classmethod
    def setUpClass(cls):
        cls.sif1 = StructInputFile.from_file(os.path.join(test_dir, "Li.cif.gz"))
        cls.sif2 = StructInputFile.from_file(os.path.join(test_dir, "LiFePO4.cif.gz"))
        cls.sif3 = StructInputFile.from_file(os.path.join(test_dir, "Li2O.cif.gz"))
    ...
    def test_mapping(self):
        ...
        sif4 = StructInputFile.from_file(os.path.join(test_dir, "CuCl.cif.gz"))
        inp_set["cif4"] = sif4
