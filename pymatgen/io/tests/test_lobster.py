...
class FatbandTest(PymatgenTest):
    def setUp(self):
        ...
        self.fatband_SiO2_p_x=Fatband(filenames=os.path.join(test_dir,"Fatband_SiO2/Test_p_x"),Kpointsfile=os.path.join(test_dir,"Fatband_SiO2/Test_p_x/KPOINTS"),vasprun=os.path.join(test_dir,"Fatband_SiO2/Test_p_x/vasprun.xml")  )
        ...
        self.fatband_SiO2_p=Fatband(filenames=os.path.join(test_dir,"Fatband_SiO2/Test_p"),Kpointsfile=os.path.join(test_dir,"Fatband_SiO2/Test_p/KPOINTS"),vasprun=os.path.join(test_dir,"Fatband_SiO2/Test_p/vasprun.xml")  )
        ...
        self.fatband_SiO2_spin=Fatband(filenames=os.path.join(test_dir,"Fatband_SiO2/Test_Spin"),Kpointsfile=os.path.join(test_dir,"Fatband_SiO2/Test_Spin/KPOINTS"),vasprun=os.path.join(test_dir,"Fatband_SiO2/Test_Spin/vasprun.xml")  )
    ...
    def test_raises(self):
        with self.assertRaises(ValueError):
            self.fatband_SiO2_p_x = Fatband(filenames=[os.path.join(test_dir, "Fatband_SiO2/Test_p_x/FATBAND_si1_3p_x.lobster"),os.path.join(test_dir, "Fatband_SiO2/Test_p_x/FATBAND_si1_3p_x.lobster")],
        ...
        with self.assertRaises(ValueError):
            self.fatband_SiO2_p_x = Fatband(filenames=[os.path.join(test_dir, "Fatband_SiO2/Test_p_x/FATBAND_si1_3p_x.lobster"),os.path.join(test_dir, "Fatband_SiO2/Test_p/FATBAND_si1_3p.lobster")],
                                            Kpointsfile=os.path.join(test_dir, "Fatband_SiO2/Test_p_x/KPOINTS"),
                                            vasprun=os.path.join(test_dir, "Fatband_SiO2/Test_p_x/vasprun.xml"))
    ...
    def test_get_bandstructure(self):
        ...
        self.assertAlmostEqual(bs_p.get_projections_on_elements_and_orbitals({"Si":["3p"]})[Spin.up][0][0]["Si"]["3p"],0.003)
        self.assertAlmostEqual(bs_p.get_projections_on_elements_and_orbitals({"O":["2p"]})[Spin.up][0][0]["O"]["2p"],0.002*3+0.003*3)
        self.assertDictEqual(bs_p.get_projections_on_elements_and_orbitals({"Si":["3s","3p"], "O": ["2s","2p"]})[Spin.up][0][0],{'Si': {'3p': 0.003, '3s': 0.192}, 'O': {'2p': 0.015, '2s': 0.792}})
        ...
        self.assertAlmostEqual(bs_spin.get_projections_on_elements_and_orbitals({"Si": ["3p"]})[Spin.up][0][0]["Si"]["3p"],
                               0.003)
        self.assertAlmostEqual(bs_spin.get_projections_on_elements_and_orbitals({"O": ["2p"]})[Spin.up][0][0]["O"]["2p"],
                               0.002 * 3 + 0.003 * 3)
        ...
        self.assertAlmostEqual(bs_spin.get_projection_on_elements()[Spin.up][0][0]["Si"], 3 * (0.001 + 0.064))
        self.assertAlmostEqual(bs_spin.get_projections_on_elements_and_orbitals({"Si": ["3p"]})[Spin.down][0][0]["Si"]["3p"],
                               0.003)
        self.assertAlmostEqual(bs_spin.get_projections_on_elements_and_orbitals({"O": ["2p"]})[Spin.down][0][0]["O"]["2p"],
                               0.002 * 3 + 0.003 * 3)
        self.assertDictEqual(
