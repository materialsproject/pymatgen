...
TITLE Source:  ../test_files/CoO19128.cif
...
class  FeffTagsTest(unittest.TestCase):
    ...
    def test_to_dict_and_from_dict(self):
        ...
        d = FeffTags.from_file(file_name)
        tags = FeffTags(d).to_dict
...
class FeffLdosTest(unittest.TestCase):
    ...
    l = FeffLdos(filepath1, filepath2)
...
class XmuTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        x = Xmu(filepath1, filepath2)
        self.assertEqual(x.to_dict['atom'], 'O',
                         "failed to form absorption dictionary")
