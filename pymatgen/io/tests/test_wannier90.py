...
class UnkTest(PymatgenTest):
    ...
    def test_from_file(self):
        unk = Unk.from_file(f"{self.TEST_FILES_DIR}/UNK.std.gz")
        assert unk.ik == 1
        assert unk.nbnd == 5
        assert unk.ng[0] == 6
        assert unk.ng[1] == 6
        ...
        unk = Unk.from_file(f"{self.TEST_FILES_DIR}/UNK.ncl.gz")
        assert unk.ik == 1
        assert unk.nbnd == 5
        assert unk.ng[0] == 6
        assert unk.ng[1] == 6
    ...
    def test_read_write(self):
        unk0 = Unk.from_file(f"{self.TEST_FILES_DIR}/UNK.std.gz")
        unk0.write_file("UNK00001.1")
        unk1 = Unk.from_file("UNK00001.1")
        assert unk0 == unk1

        unk0 = Unk.from_file(f"{self.TEST_FILES_DIR}/UNK.ncl.gz")
