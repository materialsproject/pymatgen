...
class ConvergenceTest(PymatgenTest):
    ...
    def test_determine_convergence(self):
        ...
        ys = [4, 5, 6, 6, 6, 6]
        self.assertEqual(determine_convergence(xs, ys, name='name', tol=0.1),
        ...
        self.assertEqual(determine_convergence(xs, ys, name='name', tol=0.3),
                         [True, 3, 0.3333333333333333, 2, 0.0, -0.12813051146384496])
        # a non converging example
        ys = [4, 5, 6, 7, 8, 9]
        self.assertEqual(determine_convergence(xs, ys, name='name', tol=0.01),
