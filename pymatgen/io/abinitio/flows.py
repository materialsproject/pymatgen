...
def phonon_flow(workdir, manager, scf_input, ph_inputs, with_nscf=False, with_ddk=False, with_dde=False):
    ...
    if with_ddk:
        ...
        ddk_task = flow.register_task(ddk_input, deps={scf_task: ('WFK', '1WF')}, task_class=DdkTask)
    ...
    if with_dde:
        ...
        dde_task = flow.register_task(dde_input, deps={scf_task: ('WFK', '1WF'), ddk_task: 'DDB'}, task_class=DdeTask)
