...
def get_crystal_field_spin(specie, coordination="oct", spin_config="high"):
    """
    ...
    Args:
        specie:
            A Specie object, i.e. Element with spin. Must be a transition
            metal.
        coordination:
    ...
    Raises:
        ValueError if invalid specie, coordination or spin_config.
    """
