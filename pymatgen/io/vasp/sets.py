...
class DictSet(VaspInputSet):
    ...
    def calculate_ng(
        self, max_prime_factor: int = 7, must_inc_2: bool = True, custom_encut: float | None = None
    ) -> tuple:
        """
        ...
        Args:
            ...
            custom_encut (float | int | None): Calculates the FFT grid parameters using a custom
                encut that may be different from what is generated by the input set.
