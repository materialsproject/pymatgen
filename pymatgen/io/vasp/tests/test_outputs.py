...
class VasprunTest(PymatgenTest):
    ...
    def test_runtype(self):
        ...
        v5 = Vasprun(self.TEST_FILES_DIR / "vasprun.xml.PBE+U")
        self.assertIn(v5.run_type, "PBE+U")
        v6 = Vasprun(self.TEST_FILES_DIR / "vasprun.xml.PBESol.revTPSS")
        self.assertIn(v6.run_type, "PBE+revTPSS")
        v7 = Vasprun(self.TEST_FILES_DIR / "vasprun.xml.optB88")
