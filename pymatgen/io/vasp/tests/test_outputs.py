...
class VasprunTest(PymatgenTest):
    ...
    def test_runtype(self):
        v = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "HSE06" / "vasprun.xml.HSE06")
        self.assertIn(v.run_type, "HSE06")
        v1 = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "PBESol" / "vasprun.xml.PBESol")
        self.assertIn(v1.run_type, "PBESol")
        v2 = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "vasprun.xml")
        self.assertIn(v2.run_type, "PBEO or other Hybrid Functional")
        v3 = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "PBESol_SCAN" / "vasprun.xml.PBESol.SCAN")
        self.assertIn(v3.run_type, "PBESol+SCAN")
        v4 = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "PBESol_SCAN_rVV10" / "vasprun.xml.PBESol.SCAN.rVV10")
        self.assertIn(v4.run_type, "PBESol+SCAN+rVV10")
        v5 = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "PBESol+U" / "vasprun.xml.PBE+U")
        self.assertIn(v5.run_type, "PBE+U")
        v6 = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "PBE_revTPSS" / "vasprun.xml.PBESol.revTPSS")
        self.assertIn(v6.run_type, "PBE+revTPSS")
        v7 = Vasprun(self.TEST_FILES_DIR / "run_type_method_tests" / "optB88" / "vasprun.xml.optB88")
        self.assertIn(v7.run_type, "optB88")
