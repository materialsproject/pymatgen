...
class OptimadeStructureAdapter:
    ...
    @staticmethod
    def get_structure(resource: dict, embed_as_properties: bool = True) -> Structure:
        ...
        Args:
            ...
            embed_as_properties: Whether to embed the entire OPTIMADE resource dictionary
                (which may include additional custom fields) as properties in the pymatgen Structure.
        ...
        properties: dict[str, Any] = {"optimade_id": id}
        if embed_as_properties:
            properties["optimade_attributes"] = attributes
