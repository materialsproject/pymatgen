...
class Header(FeffInput):
    ...
    def __init__(self, struct, cif_file, space_number, space_group,
        ...
        Args:
            ...
            space_number:
                typically obtained from either cif_file header or
    ...
    def from_string(header_str):
        ...
        if feffpmg > 0:
            ...
            space_group = sym[0]
            space_number = sym[1]
            return Header(struct_fromfile, cif_file, space_group, space_number,
                          comment)
        else:
            raise ValueError("Header not generated by pymatgen")
