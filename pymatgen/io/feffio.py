...
class Header(FeffInput):
    ...
    def __init__(self, struct, cif_file, space_number, space_group,
        ...
        Args:
            ...
            cif_file:
                path and name of cif file used.
            space_number: typically obtained from either cif_file header or
                structure_symmetry method below
            space_group: typically obtained from either cif_file header or
                structure_symmetry method below
    ...
    @staticmethod
    def get_sym_from_cif_file(cif_file):
        """
        Static method to return space group and number from a cif_file

        Arg:
            cif_file: cif file path and name
    ...
    def from_string(header_str):
        ...
        if feffpmg > 0:
            ...
            sym=Header.structure_symmetry(struct_fromfile)
            space_group=sym[0]
            space_number=sym[1]
            
            return Header(struct_fromfile, cif_file, space_group, space_number, comment)
...
class FeffTags(dict, FeffInput):
    ...
    def diff(self, other):
        """
        Diff function for Feff parameter files.  Compares two PARAMETER files and indicates which
