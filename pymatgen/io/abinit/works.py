...
class G0W0Work(Work):
    ...
    def __init__(self, scf_inputs, nscf_inputs, scr_inputs, sigma_inputs,
        ...
        """
        Args:
            scf_inputs: Input for the SCF run, if it is a list add all but only link to the last (convergence studie)
            nscf_inputs: Input for the NSCF run, if it is a list add all but only link to the last (i.e. addditiona DOS and BANDS)
