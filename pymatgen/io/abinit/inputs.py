...
class BasicMultiDataset(object):
    ...
    def filter_by_runlevel(self, runlevel):
        """
        Return new |BasicMultiDataset| object in which only the inputs with the given runlevel are selected.
        """
        ...
        return BasicMultiDataset.from_inputs(inputs) if inputs else None
