...
class HeaderTest(unittest.TestCase):
    def test_init(self):
        filepath = os.path.join(PymatgenTest.TEST_FILES_DIR, "HEADER.gz")
    ...
    def test_as_dict_and_from_dict(self):
        file_name = os.path.join(PymatgenTest.TEST_FILES_DIR, "HEADER.gz")
...
class FeffAtomsTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        r = CifParser(os.path.join(PymatgenTest.TEST_FILES_DIR, "CoO19128.cif.gz"))
    ...
    def test_distances(self):
        ...
        atoms_2 = Atoms.atoms_string_from_file(os.path.join(PymatgenTest.TEST_FILES_DIR, "ATOMS.gz"))
    ...
    def test_atoms_from_file(self):
        filepath = os.path.join(PymatgenTest.TEST_FILES_DIR, "ATOMS.gz")
    ...
    def test_cluster_from_file(self):
        ...
        mol_2 = Atoms.cluster_from_file(os.path.join(PymatgenTest.TEST_FILES_DIR, "ATOMS.gz"))
...
class FeffTagsTest(unittest.TestCase):
    def test_init(self):
        filepath = os.path.join(PymatgenTest.TEST_FILES_DIR, "PARAMETERS.gz")
    ...
    def test_diff(self):
        filepath1 = os.path.join(PymatgenTest.TEST_FILES_DIR, "PARAMETERS.gz")
        parameters1 = Tags.from_file(filepath1)
        filepath2 = os.path.join(PymatgenTest.TEST_FILES_DIR, "PARAMETERS.2.gz")
    ...
    def test_as_dict_and_from_dict(self):
        file_name = os.path.join(PymatgenTest.TEST_FILES_DIR, "PARAMETERS.gz")
    ...
    def test_eels_tags(self):
        ...
        tags_1 = Tags.from_file(os.path.join(PymatgenTest.TEST_FILES_DIR, "feff_eels_powder.inp.gz"))
        assert dict(tags_1) == ans_1
        ans_1["ELNES"]["BEAM_ENERGY"] = "200 0 1 1"
        ans_1["ELNES"]["BEAM_DIRECTION"] = "1 0 0"
        tags_2 = Tags.from_file(os.path.join(PymatgenTest.TEST_FILES_DIR, "feff_eels_x.inp.gz"))
        assert dict(tags_2) == ans_1


class FeffPotTest(unittest.TestCase):
    def test_init(self):
        filepath = os.path.join(PymatgenTest.TEST_FILES_DIR, "POTENTIALS.gz")
