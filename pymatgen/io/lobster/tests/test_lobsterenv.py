...
class TestLobsterNeighbors(unittest.TestCase):
    ...
    def test_get_info_icohps_neighbors(self):
        ...
        self.assertAlmostEqual(results2[4], [['Re1', 'O2'], ['Re1', 'O2'], ['Re1', 'O3'], ['Re1', 'O3'], ['Re1', 'O4'],
                                             ['Re1', 'O4']])
    ...
    def test_get_sum_icohps_between_neighbors_of_atom(self):
        ...
        chemenv_here = LobsterNeighbors(are_coops=False, filename_ICOHP=os.path.join(test_dir_env,
    ...
    def test_get_plot_label(self):
        self.assertEqual(
            self.chemenvlobster1._get_plot_label(atoms=[['Re1', 'O2'], ['Re1', 'O2'], ['Re1', 'O3'], ['Re1',
                                                                                                      'O3'],
                                                        ['Re1',
                                                         'O4'],
                                                        ['Re1', 'O4']], per_bond=False), "6 x O-Re")
        self.assertEqual(
            self.chemenvlobster1._get_plot_label(atoms=[['Re1', 'O2'], ['Re1', 'O2'], ['Re1', 'O3'], ['Re1',
                                                                                                      'O3'],
                                                        ['Re1',
                                                         'O4'],
                                                        ['Si1', 'O4']], per_bond=False), "5 x O-Re, 1 x O-Si")

        self.assertEqual(
            self.chemenvlobster1._get_plot_label(atoms=[['Si1', 'O2'], ['Si1', 'O2'], ['Si1', 'O3'], ['Re1',
                                                                                                      'O3'],
                                                        ['Re1',
                                                         'O4'],
                                                        ['Si1', 'O4']], per_bond=False), "4 x O-Si, 2 x O-Re")
