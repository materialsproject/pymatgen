...
class LobsterNeighbors(NearNeighbors):
    ...
    ):  # TODO: DanielYang: add return type
    ...
    def _get_plot_label(self, atoms: list[str], per_bond: bool) -> str:
    ...
    @staticmethod
    def _determine_unit_cell(site: Site) -> list:
