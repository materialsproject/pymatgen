...
class Bandoverlaps(MSONable):
    ...
    def as_dict(self) -> dict:
        ...
        dct = {
            ...
            "bandoverlapsdict": self.bandoverlapsdict,
            "has_good_quality_maxDeviation": self.has_good_quality_maxDeviation(),
        }
...
class Grosspop(MSONable):
    ...
    def as_dict(self) -> dict:
        ...
        Returns:
            MSONable dict.
        """
        dct = {"filename": self._filename, "list_dict_grosspop": self.list_dict_grosspop}
        return jsanitize(dct, strict=True)
...
class MadelungEnergies(MSONable):
    ...
    def as_dict(self) -> dict:
        ...
        dct = {
            ...
            "madelungenergies_Mulliken": self.madelungenergies_Mulliken,
            "madelungenergies_Loewdin": self.madelungenergies_Loewdin,
        }
        return jsanitize(dct, strict=True)
...
class SitePotential(MSONable):
    ...
    def as_dict(self) -> dict:
        ...
        dct = {
            ...
            "types": self.types,
            "ewald_splitting": self.ewald_splitting,
            "sitepotentials_Mulliken": self.sitepotentials_Mulliken,
            "sitepotentials_Loewdin": self.sitepotentials_Loewdin,
            "madelungenergies_Mulliken": self.madelungenergies_Mulliken,
            "madelungenergies_Loewdin": self.madelungenergies_Loewdin,
        }
        return jsanitize(dct, strict=True)
