...
class Icohplist(MSONable):
    ...
    def __init__(
        ...
        """
        Args:
            are_coops (bool): Determines if the file is a list of ICOOPs.
                Defaults to False for ICOHPs.
            are_cobis (bool): Determines if the file is a list of ICOBIs.
                Defaults to False for ICOHPs.
...
class Lobsterout(MSONable):
    ...
    @staticmethod
    def _get_spillings(
        data: list[str], number_of_spins: Literal[1, 2]
    ) -> tuple[list, list]:  # TODO: more specific type
        charge_spilling = []
        total_spilling = []
        for row in data:
            splitrow = row.split()
            if len(splitrow) > 2 and splitrow[2] == "spilling:":
                # TODO: DanielYang: use append over += (confirm data type)
    ...
    @staticmethod
    def _get_elements_basistype_basisfunctions(data: list[str]) -> tuple[list, list, list]:
        begin = False
        end = False
        elements = []
        basistype = []
    ...
    @staticmethod
    def _get_timing(data: list[str]) -> tuple[dict, dict, dict]:
        """Get wall, user and system time."""
        begin = False
