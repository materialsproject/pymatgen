...
class SpacegroupAnalyzerTest(PymatgenTest):
    ...
    def test_get_primitive_standard_structure(self):
        ...
        structure = parser.get_structures(False)[0]
        s = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = s.get_primitive_standard_structure()
        self.assertAlmostEqual(conv.lattice.alpha, 90)
        self.assertAlmostEqual(conv.lattice.beta, 90)
        self.assertAlmostEqual(conv.lattice.gamma, 96.105285265848195)
        self.assertAlmostEqual(conv.lattice.a, 2.3779475484040464)
        self.assertAlmostEqual(conv.lattice.b, 2.3779475484040464)
        self.assertAlmostEqual(conv.lattice.c, 9.9032878699999998)
