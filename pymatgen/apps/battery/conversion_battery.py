...
class ConversionElectrode(AbstractElectrode):
    ...
    def __init__(self, element_profile, working_ion_entry, initial_comp):
        ...
        Args:
            element_profile:
                The profile obtained from a PDAnalyzer.get_element_profile.
                Essentially, a ConversionElectrode is generated by following
                the change in phase equilibria with changing lithium chemical
                potential. To do so, you need to have a PhaseDiagram constructed
                from all phases of interest in a system. E.g., if you are
                interested in FeF3 as a conversion battery, you need to have
                all known Li-Fe-F phases and construct a phase diagram.
            working_ion_entry:
