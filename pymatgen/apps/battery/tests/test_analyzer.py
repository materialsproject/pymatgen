...
class BatteryAnalyzerTest(PymatgenTest):
    ...
    def setUp(self):
        self.lifepo4 = self.load_from_internal(
            "LiFePO4", {"Li": 1, "Fe": 2, "P": 5, "O": -2}
        )
        self.nafepo4 = self.load_from_internal(
            "NaFePO4", {"Na": 1, "Fe": 2, "P": 5, "O": -2}, cation="Na"
        )
    ...
    def test_capacitygrav_calculations(self):
        ...
        self.assertAlmostEqual(
            self.lifepo4.get_max_capgrav(insert=False), lifepo4_cap, 3
        )
        ...
        self.assertAlmostEqual(
            self.li3v2p3o12.get_max_capgrav(insert=False), li3v2p3o12_cap_remove, 3
        )
        self.assertAlmostEqual(
            self.li3v2p3o12.get_max_capgrav(remove=False), li3v2p3o12_cap_insert, 3
        )
    ...
    def test_capacityvol_calculations(self):
        ...
        fepo4_cap = (
            624.82289  # this is different than lifepo4 cap if lifepo4 volume not known
        )
        ...
        self.assertAlmostEqual(
            self.lifepo4.get_max_capvol(insert=False), lifepo4_cap, 3
        )
        ...
        self.assertAlmostEqual(
            self.nafepo4.get_max_capvol(insert=False), nafepo4_cap, 3
        )
    ...
    def test_delithiation(self):
        self.assertEqual(
            self.lifemnpo4.get_removals_int_oxid(), set([1.0, 2.0, 3.0, 4.0])
        )
