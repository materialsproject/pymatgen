...
class LobsterIn(UserDict, MSONable):
    ...
    This class provides methods to create, modify, and write `lobsterin` files,
    which are input files for the LOBSTER program. It also includes utilities
    for generating related files such as INCAR, KPOINTS, and POSCAR, and for
    comparing different `lobsterin` configurations.

    Reminder: LOBSTER input keywords are not case-sensitive.

    Attributes:
        FLOAT_KEYWORDS (ClassVar[dict[str, str]]): Keywords requiring float values.
        STRING_KEYWORDS (ClassVar[dict[str, str]]): Keywords requiring string values.
        BOOLEAN_KEYWORDS (ClassVar[dict[str, str]]): Keywords that are boolean flags.
        LIST_KEYWORDS (ClassVar[dict[str, str]]): Keywords requiring lists of strings.
        AVAILABLE_KEYWORDS (ClassVar[dict[str, str]]): All known keywords mapped to their canonical forms.
    """
    ...
    def __setitem__(self, key: str, val: Any) -> None:
        """Sets a keyword-value pair in the LobsterIn object.

        Args:
            key (str): The keyword to set.
            val (Any): The value to associate with the keyword.

        Raises:
            KeyError: If the keyword is not recognized.
        """
        key = key.strip().lower()
    ...
    def __getitem__(self, key: str) -> Any:
        ...
        Args:
            key (str): The keyword to retrieve.

        Returns:
            Any: The value associated with the keyword.

        Raises:
            KeyError: If the keyword is not found.
        """
        try:
    ...
    def __contains__(self, key: str) -> bool:
        """Checks if a keyword exists in the LobsterIn object.
    ...
    def __delitem__(self, key: str) -> None:
        """Deletes a keyword from the LobsterIn object.

        Args:
            key (str): The keyword to delete.
        """
    ...
    def diff(self, other: Self) -> dict[str, dict[str, Any]]:
        ...
        Returns:
            dict[str, dict[str, Any]]: A dictionary with keys "Same" and "Different",
    ...
    def as_dict(self) -> dict:
        ...
        Returns:
            dict: A dictionary representation of the LobsterIn object.
        """
        dct = dict(self)
    ...
    def get_basis(
        ...
        Returns:
            list[str]: List of basis functions.
