...
$end"""
    ...
    def test_read_write_nbo7(self):
        ...
        ref_path = f"{TEST_DIR}/nbo7.qin"
        qcinp = QCInput.from_file(f"{TEST_FILES_DIR}/new_qchem_files/nbo7.qin")
    ...
    def test_read_write_nbo_e2pert(self):
        qcinp = QCInput.from_file(f"{TEST_FILES_DIR}/new_qchem_files/e2pert.qin")
        qcinp.write_file(f"{module_dir}/test_e2pert.qin")
        test_path = f"{TEST_FILES_DIR}/new_qchem_files/e2pert.qin"
    ...
    def test_read_write_custom_smd(self):
        qcinp = QCInput.from_file(f"{TEST_FILES_DIR}/new_qchem_files/custom_smd.qin")
        qcinp.write_file(f"{module_dir}/test_custom_smd.qin")
        test_path = f"{TEST_FILES_DIR}/new_qchem_files/custom_smd.qin"
