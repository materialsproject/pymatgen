...
class TestQCOutput(PymatgenTest):
    ...
    def test_multipole_parsing(self):
        sp = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo.qout")
        ...
        opt = QCOutput(f"{TEST_DIR}/new_qchem_files/ts.out")
    ...
    def test_structural_change(self):
        ...
        frag_1 = Molecule.from_file(f"{TEST_DIR}/new_qchem_files/test_structure_change/frag_1.xyz")
        frag_2 = Molecule.from_file(f"{TEST_DIR}/new_qchem_files/test_structure_change/frag_2.xyz")
    ...
    def test_nbo_parsing(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo.qout").data
    ...
    def test_nbo7_parsing(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo7_1.qout").data
        ...
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo7_2.qout").data
        ...
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo7_3.qout").data
    ...
    def test_nbo5_vs_nbo7_hybridization_character(self):
        data5 = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo5_1.qout").data
        data7 = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo7_1.qout").data
    ...
    def test_nbo7_infinite_e2pert(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/nbo7_inf.qout").data
        assert data["nbo_data"]["perturbation_energy"][0]["perturbation energy"][0] == float("inf")

    def test_cdft_parsing(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/cdft_simple.qout").data
    ...
    def test_pod_parsing(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/pod2_gs.out").data
        assert data["pod_coupling_eV"] == 0.247818

    def test_fodft_parsing(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/fodft.out").data
        assert data["fodft_coupling_eV"] == 0.268383

    def test_isosvp_water(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/isosvp_water_single.qcout").data
    ...
    def test_isosvp_dielst10(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/isosvp_dielst10_single.qcout").data
        assert data["solvent_method"] == "ISOSVP"
    ...
    def test_cmirs_benzene(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/cmirs_benzene_single.qcout").data
        assert data["solvent_method"] == "ISOSVP"
    ...
    def test_cmirs_dielst10(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/cmirs_dielst10_single.qcout").data
        assert data["solvent_method"] == "ISOSVP"
        assert data["solvent_data"]["isosvp"]["isosvp_dielectric"] == 10
        assert data["solvent_data"]["cmirs"]["CMIRS_enabled"]
    ...
    def test_cmirs_water(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/cmirs_water_single.qcout").data
        assert data["solvent_method"] == "ISOSVP"
    ...
    def test_nbo_hyperbonds(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/hyper.qout").data
    ...
    def test_nbo_3_c(self):
        data = QCOutput(f"{TEST_DIR}/new_qchem_files/3C.qout").data
