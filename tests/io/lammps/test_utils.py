...
class TestPolymer(unittest.TestCase):
    ...
    def setUpClass(cls):
        # head molecule
        cls.peo_head = Molecule.from_file(os.path.join(TEST_FILES_DIR, "lammps", "peo_head.xyz"))
        ...
        # chain molecule
        cls.peo_bulk = Molecule.from_file(os.path.join(TEST_FILES_DIR, "lammps", "peo_bulk.xyz"))
        ...
        # terminal molecule
        cls.peo_tail = Molecule.from_file(os.path.join(TEST_FILES_DIR, "lammps", "peo_tail.xyz"))
...
class TestPackmolOutput(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.cocktail = Molecule.from_file(os.path.join(TEST_FILES_DIR, "lammps", "cocktail.xyz"))
