...
test_dir_reci = os.path.join(TEST_FILES_DIR, "feff_reci_dos")


class TestFeffLdos(unittest.TestCase):
    filepath1 = os.path.join(TEST_FILES_DIR, "feff.inp")
    filepath2 = os.path.join(TEST_FILES_DIR, "ldos")
...
class TestXmu(unittest.TestCase):
    def test_init(self):
        filepath1 = os.path.join(TEST_FILES_DIR, "xmu.dat")
        filepath2 = os.path.join(TEST_FILES_DIR, "feff.inp")
