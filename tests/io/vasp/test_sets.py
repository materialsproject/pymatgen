...
class TestMPStaticSet(PymatgenTest):
    ...
    def test_init(self):
        prev_run = f"{TEST_FILES_DIR}/io/vasp/fixtures/relaxation"
    ...
    def test_grid_size_from_struct(self):
        ...
        fname = f"{TEST_FILES_DIR}/io/vasp/fixtures/grid_data_files/vasp_inputs_for_grid_check.json"
...
class TestMatPESStaticSet(PymatgenTest):
    ...
    def test_from_prev_calc(self):
        vis = MatPESStaticSet.from_prev_calc(f"{TEST_FILES_DIR}/io/vasp/fixtures/relaxation")
        incar = vis.incar
        assert incar["GGA"] == "Pe"
        assert incar["ALGO"] == "Normal"
...
class TestMPSOCSet(PymatgenTest):
    ...
    def test_from_prev_calc(self):
        prev_run = f"{TEST_FILES_DIR}/io/vasp/fixtures/fe_monomer"
        vis = self.set.from_prev_calc(
            prev_calc_dir=prev_run,
            magmom=[3],
            saxis=(1, 0, 0),
...
class TestMPHSEBS(PymatgenTest):
    ...
    def test_init(self):
        prev_run = f"{TEST_FILES_DIR}/io/vasp/fixtures/static_silicon"
        vis = self.set.from_prev_calc(prev_calc_dir=prev_run, mode="uniform")
...
class TestMPScanStaticSet(PymatgenTest):
    def setUp(self):
        ...
        self.prev_run = f"{TEST_FILES_DIR}/io/vasp/fixtures/scan_relaxation"
...
class TestMPAbsorptionSet(PymatgenTest):
    def setUp(self):
        file_path = f"{TEST_FILES_DIR}/io/vasp/fixtures/absorption/static/POSCAR"
    ...
    def test_ipa(self):
        prev_run = f"{TEST_FILES_DIR}/io/vasp/fixtures/absorption/static"
    ...
    def test_rpa(self):
        prev_run = f"{TEST_FILES_DIR}/io/vasp/fixtures/absorption/ipa"
