...
test_dir_mol = os.path.join(TEST_FILES_DIR, "molecules")


class TestSpacegroupAnalyzer(PymatgenTest):
    def setUp(self):
        p = Poscar.from_file(os.path.join(TEST_FILES_DIR, "POSCAR"))
    ...
    def test_init_cell(self):
        ...
        li2o = Structure.from_file(os.path.join(TEST_FILES_DIR, "Li2O.cif"))
    ...
    def test_get_symmetry(self):
        ...
        Co8 = Structure.from_file(os.path.join(TEST_FILES_DIR, "Co8.cif"))
        symprec = 1e-1
    ...
    def test_find_primitive(self):
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "Li2O.cif"))
    ...
    def test_get_conventional_standard_structure(self):
        parser = CifParser(os.path.join(TEST_FILES_DIR, "bcc_1927.cif"))
        structure = parser.get_structures(False)[0]
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "btet_1915.cif"))
        structure = parser.get_structures(False)[0]
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = spga.get_conventional_standard_structure()
        assert conv.lattice.angles == (90, 90, 90)
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "orci_1010.cif"))
        structure = parser.get_structures(False)[0]
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = spga.get_conventional_standard_structure()
        assert conv.lattice.angles == (90, 90, 90)
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "orcc_1003.cif"))
        structure = parser.get_structures(False)[0]
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = spga.get_conventional_standard_structure()
        assert conv.lattice.angles == (90, 90, 90)
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "orac_632475.cif"))
        structure = parser.get_structures(False)[0]
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = spga.get_conventional_standard_structure()
        assert conv.lattice.angles == (90, 90, 90)
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "monoc_1028.cif"))
        structure = parser.get_structures(False)[0]
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = spga.get_conventional_standard_structure()
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "hex_1170.cif"))
        structure = parser.get_structures(False)[0]
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = spga.get_conventional_standard_structure()
        ...
        structure = Structure.from_file(os.path.join(TEST_FILES_DIR, "tric_684654.json"))
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        conv = spga.get_conventional_standard_structure()
    ...
    def test_get_primitive_standard_structure(self):
        ...
        parser = CifParser(os.path.join(TEST_FILES_DIR, "rhomb_3478_conv.cif"))
        structure = parser.get_structures(False)[0]
        spga = SpacegroupAnalyzer(structure, symprec=1e-2)
        prim = spga.get_primitive_standard_structure()
    ...
    def test_tricky_structure(self):
        ...
        struct = Structure.from_file(os.path.join(TEST_FILES_DIR, "POSCAR.tricky_symmetry"))
...
class TestPointGroupAnalyzer(PymatgenTest):
    ...
    def test_get_kpoint_weights(self):
        ...
        vasp_run = Vasprun(os.path.join(TEST_FILES_DIR, "vasprun.xml"))
