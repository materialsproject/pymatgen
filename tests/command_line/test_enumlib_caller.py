...
class TestEnumlibAdaptor(PymatgenTest):
    ...
    def test_init(self):
        ...
        struct = Structure.from_file(os.path.join(TEST_FILES_DIR, "EnumerateTest.json"))
    ...
    def test_rounding_errors(self):
        ...
        struct = Structure.from_file(os.path.join(TEST_FILES_DIR, "Cu7Te5.cif"))
        adaptor = EnumlibAdaptor(struct, 1, 2)
    ...
    def test_partial_disorder(self):
        struct = Structure.from_file(filename=os.path.join(TEST_FILES_DIR, "garnet.cif"))
