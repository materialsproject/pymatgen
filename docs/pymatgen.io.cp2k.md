...
### pymatgen.io.cp2k.utils.get_truncated_coulomb_cutoff(inp_struct: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure))
Get the truncated Coulomb cutoff for a given structure.


### pymatgen.io.cp2k.utils.get_unique_site_indices(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure) | [Molecule](pymatgen.core.md#pymatgen.core.structure.Molecule))
