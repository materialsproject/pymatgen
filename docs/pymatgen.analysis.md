...
* [pymatgen.analysis.diffraction package](pymatgen.analysis.diffraction.md)
    ...
    * [Subpackages](pymatgen.analysis.diffraction.md#subpackages)
...
* [pymatgen.analysis.elasticity package](pymatgen.analysis.elasticity.md)
    ...
    * [Subpackages](pymatgen.analysis.elasticity.md#subpackages)


        * [pymatgen.analysis.elasticity.tests namespace](pymatgen.analysis.elasticity.tests.md)




            * [pymatgen.analysis.elasticity.tests.test_elastic module](pymatgen.analysis.elasticity.tests.md#module-pymatgen.analysis.elasticity.tests.test_elastic)


                * [`DiffFitTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.DiffFitTest)


                    * [`DiffFitTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.DiffFitTest.setUp)


                    * [`DiffFitTest.test_find_eq_stress()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.DiffFitTest.test_find_eq_stress)


                    * [`DiffFitTest.test_fit()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.DiffFitTest.test_fit)


                    * [`DiffFitTest.test_generate_pseudo()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.DiffFitTest.test_generate_pseudo)


                    * [`DiffFitTest.test_get_diff_coeff()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.DiffFitTest.test_get_diff_coeff)


                    * [`DiffFitTest.test_get_strain_state_dict()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.DiffFitTest.test_get_strain_state_dict)


                * [`ElasticTensorExpansionTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest)


                    * [`ElasticTensorExpansionTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.setUp)


                    * [`ElasticTensorExpansionTest.tearDown()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.tearDown)


                    * [`ElasticTensorExpansionTest.test_calculate_stress()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_calculate_stress)


                    * [`ElasticTensorExpansionTest.test_energy_density()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_energy_density)


                    * [`ElasticTensorExpansionTest.test_from_diff_fit()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_from_diff_fit)


                    * [`ElasticTensorExpansionTest.test_get_compliance_expansion()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_get_compliance_expansion)


                    * [`ElasticTensorExpansionTest.test_get_effective_ecs()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_get_effective_ecs)


                    * [`ElasticTensorExpansionTest.test_get_strain_from_stress()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_get_strain_from_stress)


                    * [`ElasticTensorExpansionTest.test_get_yield_stress()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_get_yield_stress)


                    * [`ElasticTensorExpansionTest.test_gruneisen()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_gruneisen)


                    * [`ElasticTensorExpansionTest.test_init()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_init)


                    * [`ElasticTensorExpansionTest.test_thermal_expansion_coeff()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorExpansionTest.test_thermal_expansion_coeff)


                * [`ElasticTensorTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest)


                    * [`ElasticTensorTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.setUp)


                    * [`ElasticTensorTest.test_compliance_tensor()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_compliance_tensor)


                    * [`ElasticTensorTest.test_directional_elastic_mod()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_directional_elastic_mod)


                    * [`ElasticTensorTest.test_directional_poisson_ratio()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_directional_poisson_ratio)


                    * [`ElasticTensorTest.test_energy_density()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_energy_density)


                    * [`ElasticTensorTest.test_from_independent_strains()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_from_independent_strains)


                    * [`ElasticTensorTest.test_from_pseudoinverse()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_from_pseudoinverse)


                    * [`ElasticTensorTest.test_new()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_new)


                    * [`ElasticTensorTest.test_properties()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_properties)


                    * [`ElasticTensorTest.test_structure_based_methods()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.ElasticTensorTest.test_structure_based_methods)


                * [`NthOrderElasticTensorTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.NthOrderElasticTensorTest)


                    * [`NthOrderElasticTensorTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.NthOrderElasticTensorTest.setUp)


                    * [`NthOrderElasticTensorTest.test_calculate_stress()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.NthOrderElasticTensorTest.test_calculate_stress)


                    * [`NthOrderElasticTensorTest.test_energy_density()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.NthOrderElasticTensorTest.test_energy_density)


                    * [`NthOrderElasticTensorTest.test_from_diff_fit()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.NthOrderElasticTensorTest.test_from_diff_fit)


                    * [`NthOrderElasticTensorTest.test_init()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_elastic.NthOrderElasticTensorTest.test_init)


            * [pymatgen.analysis.elasticity.tests.test_strain module](pymatgen.analysis.elasticity.tests.md#module-pymatgen.analysis.elasticity.tests.test_strain)


                * [`DeformationTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformationTest)


                    * [`DeformationTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformationTest.setUp)


                    * [`DeformationTest.test_apply_to_structure()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformationTest.test_apply_to_structure)


                    * [`DeformationTest.test_independence()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformationTest.test_independence)


                    * [`DeformationTest.test_properties()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformationTest.test_properties)


                * [`DeformedStructureSetTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformedStructureSetTest)


                    * [`DeformedStructureSetTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformedStructureSetTest.setUp)


                    * [`DeformedStructureSetTest.test_init()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.DeformedStructureSetTest.test_init)


                * [`StrainTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.StrainTest)


                    * [`StrainTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.StrainTest.setUp)


                    * [`StrainTest.test_convert_strain_to_deformation()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.StrainTest.test_convert_strain_to_deformation)


                    * [`StrainTest.test_from_deformation()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.StrainTest.test_from_deformation)


                    * [`StrainTest.test_from_index_amount()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.StrainTest.test_from_index_amount)


                    * [`StrainTest.test_new()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.StrainTest.test_new)


                    * [`StrainTest.test_properties()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_strain.StrainTest.test_properties)


            * [pymatgen.analysis.elasticity.tests.test_stress module](pymatgen.analysis.elasticity.tests.md#module-pymatgen.analysis.elasticity.tests.test_stress)


                * [`StressTest`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_stress.StressTest)


                    * [`StressTest.setUp()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_stress.StressTest.setUp)


                    * [`StressTest.test_properties()`](pymatgen.analysis.elasticity.tests.md#pymatgen.analysis.elasticity.tests.test_stress.StressTest.test_properties)
...
* [pymatgen.analysis.ferroelectricity package](pymatgen.analysis.ferroelectricity.md)
    ...
    * [Subpackages](pymatgen.analysis.ferroelectricity.md#subpackages)
        ...
        * [pymatgen.analysis.ferroelectricity.tests namespace](pymatgen.analysis.ferroelectricity.tests.md)
            ...
            * [pymatgen.analysis.ferroelectricity.tests.test_polarization module](pymatgen.analysis.ferroelectricity.tests.md#module-pymatgen.analysis.ferroelectricity.tests.test_polarization)
                ...
                * [`PolarizationTest`](pymatgen.analysis.ferroelectricity.tests.md#pymatgen.analysis.ferroelectricity.tests.test_polarization.PolarizationTest)
                    ...
                    * [`PolarizationTest.test_get_polarization_change()`](pymatgen.analysis.ferroelectricity.tests.md#pymatgen.analysis.ferroelectricity.tests.test_polarization.PolarizationTest.test_get_polarization_change)
...
* [pymatgen.analysis.gb package](pymatgen.analysis.gb.md)
    ...
    * [Subpackages](pymatgen.analysis.gb.md#subpackages)
...
* [pymatgen.analysis.interfaces package](pymatgen.analysis.interfaces.md)
    ...
    * [Subpackages](pymatgen.analysis.interfaces.md#subpackages)
        ...
        * [pymatgen.analysis.interfaces.tests namespace](pymatgen.analysis.interfaces.tests.md)
            ...
            * [pymatgen.analysis.interfaces.tests.test_zsl module](pymatgen.analysis.interfaces.tests.md#module-pymatgen.analysis.interfaces.tests.test_zsl)
                ...
                * [`ZSLGenTest`](pymatgen.analysis.interfaces.tests.md#pymatgen.analysis.interfaces.tests.test_zsl.ZSLGenTest)
                    ...
                    * [`ZSLGenTest.test_bidirectional()`](pymatgen.analysis.interfaces.tests.md#pymatgen.analysis.interfaces.tests.test_zsl.ZSLGenTest.test_bidirectional)
...
* [pymatgen.analysis.magnetism package](pymatgen.analysis.magnetism.md)
    ...
    * [Subpackages](pymatgen.analysis.magnetism.md#subpackages)
...
* [pymatgen.analysis.solar package](pymatgen.analysis.solar.md)
    ...
    * [Subpackages](pymatgen.analysis.solar.md#subpackages)
    ...
    * [pymatgen.analysis.solar.slme module](pymatgen.analysis.solar.md#module-pymatgen.analysis.solar.slme)
        ...
        * [`matrix_eigvals()`](pymatgen.analysis.solar.md#pymatgen.analysis.solar.slme.matrix_eigvals)
...
* [pymatgen.analysis.structure_prediction package](pymatgen.analysis.structure_prediction.md)
    ...
    * [Subpackages](pymatgen.analysis.structure_prediction.md#subpackages)
...
* [pymatgen.analysis.tests namespace](pymatgen.analysis.tests.md)




    * [pymatgen.analysis.tests.test_adsorption module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_adsorption)


        * [`AdsorbateSiteFinderTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest)


            * [`AdsorbateSiteFinderTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.setUp)


            * [`AdsorbateSiteFinderTest.test_adsorb_both_surfaces()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.test_adsorb_both_surfaces)


            * [`AdsorbateSiteFinderTest.test_find_adsorption_sites()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.test_find_adsorption_sites)


            * [`AdsorbateSiteFinderTest.test_from_bulk_and_miller()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.test_from_bulk_and_miller)


            * [`AdsorbateSiteFinderTest.test_functions()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.test_functions)


            * [`AdsorbateSiteFinderTest.test_generate_adsorption_structures()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.test_generate_adsorption_structures)


            * [`AdsorbateSiteFinderTest.test_generate_substitution_structures()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.test_generate_substitution_structures)


            * [`AdsorbateSiteFinderTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_adsorption.AdsorbateSiteFinderTest.test_init)


    * [pymatgen.analysis.tests.test_bond_dissociation module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_bond_dissociation)


        * [`BondDissociationTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_dissociation.BondDissociationTest)


            * [`BondDissociationTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_dissociation.BondDissociationTest.setUp)


            * [`BondDissociationTest.test_ec_neg_pcm_40()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_dissociation.BondDissociationTest.test_ec_neg_pcm_40)


            * [`BondDissociationTest.test_pc_neutral_pcm_65()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_dissociation.BondDissociationTest.test_pc_neutral_pcm_65)


            * [`BondDissociationTest.test_tfsi_neg_no_pcm()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_dissociation.BondDissociationTest.test_tfsi_neg_no_pcm)


    * [pymatgen.analysis.tests.test_bond_valence module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_bond_valence)


        * [`BVAnalyzerTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_valence.BVAnalyzerTest)


            * [`BVAnalyzerTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_valence.BVAnalyzerTest.setUp)


            * [`BVAnalyzerTest.test_get_oxi_state_structure()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_valence.BVAnalyzerTest.test_get_oxi_state_structure)


            * [`BVAnalyzerTest.test_get_valence()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_valence.BVAnalyzerTest.test_get_valence)


        * [`BondValenceSumTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_valence.BondValenceSumTest)


            * [`BondValenceSumTest.test_calculate_bv_sum()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_valence.BondValenceSumTest.test_calculate_bv_sum)


            * [`BondValenceSumTest.test_calculate_bv_sum_unordered()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_bond_valence.BondValenceSumTest.test_calculate_bv_sum_unordered)


    * [pymatgen.analysis.tests.test_chempot_diagram module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_chempot_diagram)


        * [`ChemicalPotentialDiagramTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest)


            * [`ChemicalPotentialDiagramTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.setUp)


            * [`ChemicalPotentialDiagramTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.tearDown)


            * [`ChemicalPotentialDiagramTest.test_border_hyperplanes()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_border_hyperplanes)


            * [`ChemicalPotentialDiagramTest.test_centroid()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_centroid)


            * [`ChemicalPotentialDiagramTest.test_dim()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_dim)


            * [`ChemicalPotentialDiagramTest.test_domains()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_domains)


            * [`ChemicalPotentialDiagramTest.test_el_refs()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_el_refs)


            * [`ChemicalPotentialDiagramTest.test_el_refs_formal()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_el_refs_formal)


            * [`ChemicalPotentialDiagramTest.test_get_2d_orthonormal_vector()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_get_2d_orthonormal_vector)


            * [`ChemicalPotentialDiagramTest.test_get_plot()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_get_plot)


            * [`ChemicalPotentialDiagramTest.test_lims()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_lims)


            * [`ChemicalPotentialDiagramTest.test_pca()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_chempot_diagram.ChemicalPotentialDiagramTest.test_pca)


    * [pymatgen.analysis.tests.test_cost module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_cost)


        * [`CostAnalyzerTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_cost.CostAnalyzerTest)


            * [`CostAnalyzerTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_cost.CostAnalyzerTest.setUp)


            * [`CostAnalyzerTest.test_cost_per_kg()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_cost.CostAnalyzerTest.test_cost_per_kg)


            * [`CostAnalyzerTest.test_cost_per_mol()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_cost.CostAnalyzerTest.test_cost_per_mol)


            * [`CostAnalyzerTest.test_sanity()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_cost.CostAnalyzerTest.test_sanity)


        * [`CostDBTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_cost.CostDBTest)


            * [`CostDBTest.test_sanity()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_cost.CostDBTest.test_sanity)


    * [pymatgen.analysis.tests.test_dimensionality module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_dimensionality)


        * [`CheonDimensionalityTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.CheonDimensionalityTest)


            * [`CheonDimensionalityTest.test_get_dimensionality()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.CheonDimensionalityTest.test_get_dimensionality)


            * [`CheonDimensionalityTest.test_get_dimensionality_with_bonds()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.CheonDimensionalityTest.test_get_dimensionality_with_bonds)


            * [`CheonDimensionalityTest.test_tricky_structure()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.CheonDimensionalityTest.test_tricky_structure)


        * [`GoraiDimensionalityTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.GoraiDimensionalityTest)


            * [`GoraiDimensionalityTest.test_get_dimensionality()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.GoraiDimensionalityTest.test_get_dimensionality)


            * [`GoraiDimensionalityTest.test_get_dimensionality_with_bonds()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.GoraiDimensionalityTest.test_get_dimensionality_with_bonds)


        * [`LarsenDimensionalityTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest)


            * [`LarsenDimensionalityTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest.setUp)


            * [`LarsenDimensionalityTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest.tearDown)


            * [`LarsenDimensionalityTest.test_calculate_dimensionality_of_site()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest.test_calculate_dimensionality_of_site)


            * [`LarsenDimensionalityTest.test_get_dimensionality()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest.test_get_dimensionality)


            * [`LarsenDimensionalityTest.test_get_structure_components()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest.test_get_structure_components)


            * [`LarsenDimensionalityTest.test_tricky_structure()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest.test_tricky_structure)


            * [`LarsenDimensionalityTest.test_zero_d_to_molecule_graph()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_dimensionality.LarsenDimensionalityTest.test_zero_d_to_molecule_graph)


    * [pymatgen.analysis.tests.test_disorder module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_disorder)


        * [`OrderParameterTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_disorder.OrderParameterTest)


            * [`OrderParameterTest.test_compute_warren_cowley_parameters()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_disorder.OrderParameterTest.test_compute_warren_cowley_parameters)


    * [pymatgen.analysis.tests.test_energy_models module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_energy_models)


        * [`EwaldElectrostaticModelTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.EwaldElectrostaticModelTest)


            * [`EwaldElectrostaticModelTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.EwaldElectrostaticModelTest.setUp)


            * [`EwaldElectrostaticModelTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.EwaldElectrostaticModelTest.tearDown)


            * [`EwaldElectrostaticModelTest.test_get_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.EwaldElectrostaticModelTest.test_get_energy)


            * [`EwaldElectrostaticModelTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.EwaldElectrostaticModelTest.test_to_from_dict)


        * [`IsingModelTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.IsingModelTest)


            * [`IsingModelTest.test_get_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.IsingModelTest.test_get_energy)


            * [`IsingModelTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.IsingModelTest.test_to_from_dict)


        * [`SymmetryModelTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.SymmetryModelTest)


            * [`SymmetryModelTest.test_get_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.SymmetryModelTest.test_get_energy)


            * [`SymmetryModelTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_energy_models.SymmetryModelTest.test_to_from_dict)


    * [pymatgen.analysis.tests.test_eos module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_eos)


        * [`EOSTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest)


            * [`EOSTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.setUp)


            * [`EOSTest.test_eos_func()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.test_eos_func)


            * [`EOSTest.test_eos_func_call()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.test_eos_func_call)


            * [`EOSTest.test_fitting()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.test_fitting)


            * [`EOSTest.test_numerical_eos_values()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.test_numerical_eos_values)


            * [`EOSTest.test_numerical_eoswrapper()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.test_numerical_eoswrapper)


            * [`EOSTest.test_run_all_models()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.test_run_all_models)


            * [`EOSTest.test_summary_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_eos.EOSTest.test_summary_dict)


    * [pymatgen.analysis.tests.test_ewald module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_ewald)


        * [`EwaldMinimizerTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldMinimizerTest)


            * [`EwaldMinimizerTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldMinimizerTest.setUp)


            * [`EwaldMinimizerTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldMinimizerTest.tearDown)


            * [`EwaldMinimizerTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldMinimizerTest.test_init)


            * [`EwaldMinimizerTest.test_site()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldMinimizerTest.test_site)


        * [`EwaldSummationTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldSummationTest)


            * [`EwaldSummationTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldSummationTest.setUp)


            * [`EwaldSummationTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldSummationTest.tearDown)


            * [`EwaldSummationTest.test_as_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldSummationTest.test_as_dict)


            * [`EwaldSummationTest.test_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldSummationTest.test_from_dict)


            * [`EwaldSummationTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_ewald.EwaldSummationTest.test_init)


    * [pymatgen.analysis.tests.test_fragmenter module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_fragmenter)


        * [`TestFragmentMolecule`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule)


            * [`TestFragmentMolecule.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.setUpClass)


            * [`TestFragmentMolecule.test_babel_pc_defaults()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_babel_pc_defaults)


            * [`TestFragmentMolecule.test_babel_pc_frag1()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_babel_pc_frag1)


            * [`TestFragmentMolecule.test_babel_pc_old_defaults()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_babel_pc_old_defaults)


            * [`TestFragmentMolecule.test_babel_pc_with_ro_depth_0_vs_depth_10()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_babel_pc_with_ro_depth_0_vs_depth_10)


            * [`TestFragmentMolecule.test_babel_tfsi()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_babel_tfsi)


            * [`TestFragmentMolecule.test_edges_given_pc_frag1()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_edges_given_pc_frag1)


            * [`TestFragmentMolecule.test_edges_given_pc_not_defaults()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_edges_given_pc_not_defaults)


            * [`TestFragmentMolecule.test_edges_given_tfsi()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_edges_given_tfsi)


            * [`TestFragmentMolecule.test_pc_depth_0_vs_depth_10()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_pc_depth_0_vs_depth_10)


            * [`TestFragmentMolecule.test_pc_frag1_then_pc()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_pc_frag1_then_pc)


            * [`TestFragmentMolecule.test_pc_then_ec_depth_10()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_fragmenter.TestFragmentMolecule.test_pc_then_ec_depth_10)


    * [pymatgen.analysis.tests.test_functional_groups module](pymatgen.analysis.tests.md#pymatgen-analysis-tests-test-functional-groups-module)


    * [pymatgen.analysis.tests.test_graphs module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_graphs)


        * [`MoleculeGraphTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest)


            * [`MoleculeGraphTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.setUp)


            * [`MoleculeGraphTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.tearDown)


            * [`MoleculeGraphTest.test_as_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_as_from_dict)


            * [`MoleculeGraphTest.test_build_unique_fragments()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_build_unique_fragments)


            * [`MoleculeGraphTest.test_construction()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_construction)


            * [`MoleculeGraphTest.test_coordination()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_coordination)


            * [`MoleculeGraphTest.test_edge_editing()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_edge_editing)


            * [`MoleculeGraphTest.test_find_rings()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_find_rings)


            * [`MoleculeGraphTest.test_get_disconnected()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_get_disconnected)


            * [`MoleculeGraphTest.test_insert_remove()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_insert_remove)


            * [`MoleculeGraphTest.test_isomorphic()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_isomorphic)


            * [`MoleculeGraphTest.test_properties()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_properties)


            * [`MoleculeGraphTest.test_replace()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_replace)


            * [`MoleculeGraphTest.test_set_node_attributes()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_set_node_attributes)


            * [`MoleculeGraphTest.test_sort()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_sort)


            * [`MoleculeGraphTest.test_split()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_split)


            * [`MoleculeGraphTest.test_substitute()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.MoleculeGraphTest.test_substitute)


        * [`StructureGraphTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest)


            * [`StructureGraphTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.setUp)


            * [`StructureGraphTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.tearDown)


            * [`StructureGraphTest.test_auto_image_detection()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_auto_image_detection)


            * [`StructureGraphTest.test_draw()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_draw)


            * [`StructureGraphTest.test_edge_editing()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_edge_editing)


            * [`StructureGraphTest.test_extract_molecules()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_extract_molecules)


            * [`StructureGraphTest.test_from_edges()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_from_edges)


            * [`StructureGraphTest.test_from_local_env_and_equality_and_diff()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_from_local_env_and_equality_and_diff)


            * [`StructureGraphTest.test_inappropriate_construction()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_inappropriate_construction)


            * [`StructureGraphTest.test_insert_remove()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_insert_remove)


            * [`StructureGraphTest.test_mul()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_mul)


            * [`StructureGraphTest.test_no_duplicate_hops()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_no_duplicate_hops)


            * [`StructureGraphTest.test_properties()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_properties)


            * [`StructureGraphTest.test_set_node_attributes()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_set_node_attributes)


            * [`StructureGraphTest.test_sort()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_sort)


            * [`StructureGraphTest.test_str()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_str)


            * [`StructureGraphTest.test_substitute()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_substitute)


            * [`StructureGraphTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_to_from_dict)


            * [`StructureGraphTest.test_types_and_weights_of_connections()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_types_and_weights_of_connections)


            * [`StructureGraphTest.test_types_of_coordination_environments()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_types_of_coordination_environments)


            * [`StructureGraphTest.test_weight_statistics()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_graphs.StructureGraphTest.test_weight_statistics)


    * [pymatgen.analysis.tests.test_hhi module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_hhi)


        * [`HHIModelTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_hhi.HHIModelTest)


            * [`HHIModelTest.test_hhi()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_hhi.HHIModelTest.test_hhi)


    * [pymatgen.analysis.tests.test_interface_reactions module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_interface_reactions)


        * [`InterfaceReactionTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest)


            * [`InterfaceReactionTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.setUp)


            * [`InterfaceReactionTest.test_convert()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_convert)


            * [`InterfaceReactionTest.test_convexity()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_convexity)


            * [`InterfaceReactionTest.test_get_chempot_correction()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_chempot_correction)


            * [`InterfaceReactionTest.test_get_critical_original_kink_ratio()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_critical_original_kink_ratio)


            * [`InterfaceReactionTest.test_get_dataframe()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_dataframe)


            * [`InterfaceReactionTest.test_get_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_energy)


            * [`InterfaceReactionTest.test_get_entry_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_entry_energy)


            * [`InterfaceReactionTest.test_get_get_elmt_amt_in_rxt()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_get_elmt_amt_in_rxt)


            * [`InterfaceReactionTest.test_get_grand_potential()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_grand_potential)


            * [`InterfaceReactionTest.test_get_kinks()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_kinks)


            * [`InterfaceReactionTest.test_get_no_mixing_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_no_mixing_energy)


            * [`InterfaceReactionTest.test_get_original_composition_ratio()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_original_composition_ratio)


            * [`InterfaceReactionTest.test_get_reaction()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_get_reaction)


            * [`InterfaceReactionTest.test_labels()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_labels)


            * [`InterfaceReactionTest.test_minimum()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_minimum)


            * [`InterfaceReactionTest.test_plot()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_plot)


            * [`InterfaceReactionTest.test_products_property()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_products_property)


            * [`InterfaceReactionTest.test_reverse_convert()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_interface_reactions.InterfaceReactionTest.test_reverse_convert)


    * [pymatgen.analysis.tests.test_local_env module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_local_env)


        * [`CovalentBondNNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CovalentBondNNTest)


            * [`CovalentBondNNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CovalentBondNNTest.setUp)


            * [`CovalentBondNNTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CovalentBondNNTest.tearDown)


            * [`CovalentBondNNTest.test_bonded_structure()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CovalentBondNNTest.test_bonded_structure)


            * [`CovalentBondNNTest.test_nn_length()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CovalentBondNNTest.test_nn_length)


            * [`CovalentBondNNTest.test_nn_orders()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CovalentBondNNTest.test_nn_orders)


        * [`Critic2NNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.Critic2NNTest)


            * [`Critic2NNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.Critic2NNTest.setUp)


            * [`Critic2NNTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.Critic2NNTest.tearDown)


            * [`Critic2NNTest.test_cn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.Critic2NNTest.test_cn)


        * [`CrystalNNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest)


            * [`CrystalNNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.setUp)


            * [`CrystalNNTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.tearDown)


            * [`CrystalNNTest.test_cation_anion()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_cation_anion)


            * [`CrystalNNTest.test_discrete_cn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_discrete_cn)


            * [`CrystalNNTest.test_fixed_length()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_fixed_length)


            * [`CrystalNNTest.test_get_bonded_structure()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_get_bonded_structure)


            * [`CrystalNNTest.test_get_cn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_get_cn)


            * [`CrystalNNTest.test_noble_gas_material()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_noble_gas_material)


            * [`CrystalNNTest.test_sanity()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_sanity)


            * [`CrystalNNTest.test_shifted_sites()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_shifted_sites)


            * [`CrystalNNTest.test_weighted_cn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_weighted_cn)


            * [`CrystalNNTest.test_weighted_cn_no_oxid()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_weighted_cn_no_oxid)


            * [`CrystalNNTest.test_x_diff_weight()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CrystalNNTest.test_x_diff_weight)


        * [`CutOffDictNNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CutOffDictNNTest)


            * [`CutOffDictNNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CutOffDictNNTest.setUp)


            * [`CutOffDictNNTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CutOffDictNNTest.tearDown)


            * [`CutOffDictNNTest.test_cn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CutOffDictNNTest.test_cn)


            * [`CutOffDictNNTest.test_from_preset()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.CutOffDictNNTest.test_from_preset)


        * [`JmolNNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.JmolNNTest)


            * [`JmolNNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.JmolNNTest.setUp)


            * [`JmolNNTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.JmolNNTest.tearDown)


            * [`JmolNNTest.test_get_nn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.JmolNNTest.test_get_nn)


        * [`LocalStructOrderParamsTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.LocalStructOrderParamsTest)


            * [`LocalStructOrderParamsTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.LocalStructOrderParamsTest.setUp)


            * [`LocalStructOrderParamsTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.LocalStructOrderParamsTest.tearDown)


            * [`LocalStructOrderParamsTest.test_get_order_parameters()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.LocalStructOrderParamsTest.test_get_order_parameters)


            * [`LocalStructOrderParamsTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.LocalStructOrderParamsTest.test_init)


        * [`MetalEdgeExtenderTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MetalEdgeExtenderTest)


            * [`MetalEdgeExtenderTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MetalEdgeExtenderTest.setUp)


            * [`MetalEdgeExtenderTest.test_custom_coordinators()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MetalEdgeExtenderTest.test_custom_coordinators)


            * [`MetalEdgeExtenderTest.test_custom_cutoff()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MetalEdgeExtenderTest.test_custom_cutoff)


            * [`MetalEdgeExtenderTest.test_custom_metals()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MetalEdgeExtenderTest.test_custom_metals)


            * [`MetalEdgeExtenderTest.test_metal_edge_extender()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MetalEdgeExtenderTest.test_metal_edge_extender)


            * [`MetalEdgeExtenderTest.test_oxygen_edge_extender()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MetalEdgeExtenderTest.test_oxygen_edge_extender)


        * [`MiniDistNNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MiniDistNNTest)


            * [`MiniDistNNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MiniDistNNTest.setUp)


            * [`MiniDistNNTest.test_all_nn_classes()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MiniDistNNTest.test_all_nn_classes)


            * [`MiniDistNNTest.test_get_local_order_params()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MiniDistNNTest.test_get_local_order_params)


        * [`MotifIdentificationTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MotifIdentificationTest)


            * [`MotifIdentificationTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MotifIdentificationTest.setUp)


            * [`MotifIdentificationTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MotifIdentificationTest.tearDown)


            * [`MotifIdentificationTest.test_get_neighbors_of_site_with_index()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MotifIdentificationTest.test_get_neighbors_of_site_with_index)


            * [`MotifIdentificationTest.test_site_is_of_motif_type()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.MotifIdentificationTest.test_site_is_of_motif_type)


        * [`NearNeighborTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.NearNeighborTest)


            * [`NearNeighborTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.NearNeighborTest.setUp)


            * [`NearNeighborTest.set_nn_info()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.NearNeighborTest.set_nn_info)


            * [`NearNeighborTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.NearNeighborTest.tearDown)


            * [`NearNeighborTest.test_on_disorder_options()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.NearNeighborTest.test_on_disorder_options)


        * [`OpenBabelNNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.OpenBabelNNTest)


            * [`OpenBabelNNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.OpenBabelNNTest.setUp)


            * [`OpenBabelNNTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.OpenBabelNNTest.tearDown)


            * [`OpenBabelNNTest.test_nn_length()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.OpenBabelNNTest.test_nn_length)


            * [`OpenBabelNNTest.test_nn_orders()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.OpenBabelNNTest.test_nn_orders)


        * [`TestIsayevNN`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.TestIsayevNN)


            * [`TestIsayevNN.test_get_nn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.TestIsayevNN.test_get_nn)


        * [`ValenceIonicRadiusEvaluatorTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.ValenceIonicRadiusEvaluatorTest)


            * [`ValenceIonicRadiusEvaluatorTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.ValenceIonicRadiusEvaluatorTest.setUp)


            * [`ValenceIonicRadiusEvaluatorTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.ValenceIonicRadiusEvaluatorTest.tearDown)


            * [`ValenceIonicRadiusEvaluatorTest.test_radii_ionic_structure()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.ValenceIonicRadiusEvaluatorTest.test_radii_ionic_structure)


            * [`ValenceIonicRadiusEvaluatorTest.test_valences_ionic_structure()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.ValenceIonicRadiusEvaluatorTest.test_valences_ionic_structure)


        * [`VoronoiNNTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest)


            * [`VoronoiNNTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.setUp)


            * [`VoronoiNNTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.tearDown)


            * [`VoronoiNNTest.test_Cs2O()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_Cs2O)


            * [`VoronoiNNTest.test_adj_neighbors()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_adj_neighbors)


            * [`VoronoiNNTest.test_all_at_once()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_all_at_once)


            * [`VoronoiNNTest.test_filtered()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_filtered)


            * [`VoronoiNNTest.test_get_cn()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_get_cn)


            * [`VoronoiNNTest.test_get_coordinated_sites()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_get_coordinated_sites)


            * [`VoronoiNNTest.test_get_voronoi_polyhedra()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_get_voronoi_polyhedra)


            * [`VoronoiNNTest.test_nn_shell()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_nn_shell)


            * [`VoronoiNNTest.test_solid_angle()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_solid_angle)


            * [`VoronoiNNTest.test_volume()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_local_env.VoronoiNNTest.test_volume)


    * [pymatgen.analysis.tests.test_molecule_matcher module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_molecule_matcher)


        * [`BruteForceOrderMatcherSi2OTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSi2OTest)


            * [`BruteForceOrderMatcherSi2OTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSi2OTest.setUpClass)


            * [`BruteForceOrderMatcherSi2OTest.test_mismatched_atoms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSi2OTest.test_mismatched_atoms)


            * [`BruteForceOrderMatcherSi2OTest.test_permuted_atoms_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSi2OTest.test_permuted_atoms_order)


            * [`BruteForceOrderMatcherSi2OTest.test_perturbed_atom_position()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSi2OTest.test_perturbed_atom_position)


            * [`BruteForceOrderMatcherSi2OTest.test_random_match()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSi2OTest.test_random_match)


            * [`BruteForceOrderMatcherSi2OTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSi2OTest.test_rotated_molecule)


        * [`BruteForceOrderMatcherSiTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSiTest)


            * [`BruteForceOrderMatcherSiTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSiTest.setUpClass)


            * [`BruteForceOrderMatcherSiTest.test_random_match()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSiTest.test_random_match)


            * [`BruteForceOrderMatcherSiTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.BruteForceOrderMatcherSiTest.test_to_and_from_dict)


        * [`GeneticOrderMatcherSi2OTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSi2OTest)


            * [`GeneticOrderMatcherSi2OTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSi2OTest.setUpClass)


            * [`GeneticOrderMatcherSi2OTest.test_mismatched_atoms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSi2OTest.test_mismatched_atoms)


            * [`GeneticOrderMatcherSi2OTest.test_permuted_atoms_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSi2OTest.test_permuted_atoms_order)


            * [`GeneticOrderMatcherSi2OTest.test_perturbed_atom_position()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSi2OTest.test_perturbed_atom_position)


            * [`GeneticOrderMatcherSi2OTest.test_random_match()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSi2OTest.test_random_match)


            * [`GeneticOrderMatcherSi2OTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSi2OTest.test_rotated_molecule)


        * [`GeneticOrderMatcherSiTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest)


            * [`GeneticOrderMatcherSiTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest.setUpClass)


            * [`GeneticOrderMatcherSiTest.test_mismatched_atoms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest.test_mismatched_atoms)


            * [`GeneticOrderMatcherSiTest.test_permuted_atoms_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest.test_permuted_atoms_order)


            * [`GeneticOrderMatcherSiTest.test_perturbed_atom_position()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest.test_perturbed_atom_position)


            * [`GeneticOrderMatcherSiTest.test_random_match()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest.test_random_match)


            * [`GeneticOrderMatcherSiTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest.test_rotated_molecule)


            * [`GeneticOrderMatcherSiTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherSiTest.test_to_and_from_dict)


        * [`GeneticOrderMatcherTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherTest)


            * [`GeneticOrderMatcherTest.test_fit()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherTest.test_fit)


            * [`GeneticOrderMatcherTest.test_get_rmsd()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherTest.test_get_rmsd)


            * [`GeneticOrderMatcherTest.test_mismatched_atom_composition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherTest.test_mismatched_atom_composition)


            * [`GeneticOrderMatcherTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherTest.test_rotated_molecule)


            * [`GeneticOrderMatcherTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.GeneticOrderMatcherTest.test_to_and_from_dict)


        * [`HungarianOrderMatcherSi2OTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSi2OTest)


            * [`HungarianOrderMatcherSi2OTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSi2OTest.setUpClass)


            * [`HungarianOrderMatcherSi2OTest.test_mismatched_atoms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSi2OTest.test_mismatched_atoms)


            * [`HungarianOrderMatcherSi2OTest.test_permuted_atoms_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSi2OTest.test_permuted_atoms_order)


            * [`HungarianOrderMatcherSi2OTest.test_perturbed_atom_position()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSi2OTest.test_perturbed_atom_position)


            * [`HungarianOrderMatcherSi2OTest.test_random_match()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSi2OTest.test_random_match)


            * [`HungarianOrderMatcherSi2OTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSi2OTest.test_rotated_molecule)


        * [`HungarianOrderMatcherSiTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest)


            * [`HungarianOrderMatcherSiTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest.setUpClass)


            * [`HungarianOrderMatcherSiTest.test_mismatched_atoms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest.test_mismatched_atoms)


            * [`HungarianOrderMatcherSiTest.test_permuted_atoms_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest.test_permuted_atoms_order)


            * [`HungarianOrderMatcherSiTest.test_perturbed_atom_position()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest.test_perturbed_atom_position)


            * [`HungarianOrderMatcherSiTest.test_random_match()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest.test_random_match)


            * [`HungarianOrderMatcherSiTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest.test_rotated_molecule)


            * [`HungarianOrderMatcherSiTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherSiTest.test_to_and_from_dict)


        * [`HungarianOrderMatcherTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherTest)


            * [`HungarianOrderMatcherTest.test_fit()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherTest.test_fit)


            * [`HungarianOrderMatcherTest.test_get_rmsd()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherTest.test_get_rmsd)


            * [`HungarianOrderMatcherTest.test_mismatched_atom_composition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherTest.test_mismatched_atom_composition)


            * [`HungarianOrderMatcherTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherTest.test_rotated_molecule)


            * [`HungarianOrderMatcherTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.HungarianOrderMatcherTest.test_to_and_from_dict)


        * [`KabschMatcherSi2OTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSi2OTest)


            * [`KabschMatcherSi2OTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSi2OTest.setUpClass)


            * [`KabschMatcherSi2OTest.test_mismatched_atoms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSi2OTest.test_mismatched_atoms)


            * [`KabschMatcherSi2OTest.test_permuted_atoms_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSi2OTest.test_permuted_atoms_order)


            * [`KabschMatcherSi2OTest.test_perturbed_atom_position()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSi2OTest.test_perturbed_atom_position)


            * [`KabschMatcherSi2OTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSi2OTest.test_rotated_molecule)


        * [`KabschMatcherSiTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSiTest)


            * [`KabschMatcherSiTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSiTest.setUpClass)


            * [`KabschMatcherSiTest.test_mismatched_atoms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSiTest.test_mismatched_atoms)


            * [`KabschMatcherSiTest.test_permuted_atoms_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSiTest.test_permuted_atoms_order)


            * [`KabschMatcherSiTest.test_perturbed_atom_position()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSiTest.test_perturbed_atom_position)


            * [`KabschMatcherSiTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSiTest.test_rotated_molecule)


            * [`KabschMatcherSiTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherSiTest.test_to_and_from_dict)


        * [`KabschMatcherTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherTest)


            * [`KabschMatcherTest.test_fit()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherTest.test_fit)


            * [`KabschMatcherTest.test_get_rmsd()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherTest.test_get_rmsd)


            * [`KabschMatcherTest.test_mismatched_atom_composition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherTest.test_mismatched_atom_composition)


            * [`KabschMatcherTest.test_mismatched_atom_order()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherTest.test_mismatched_atom_order)


            * [`KabschMatcherTest.test_rotated_molecule()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherTest.test_rotated_molecule)


            * [`KabschMatcherTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.KabschMatcherTest.test_to_and_from_dict)


        * [`MoleculeMatcherTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest)


            * [`MoleculeMatcherTest.fit_with_mapper()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.fit_with_mapper)


            * [`MoleculeMatcherTest.test_cdi_23()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_cdi_23)


            * [`MoleculeMatcherTest.test_fit()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_fit)


            * [`MoleculeMatcherTest.test_get_rmsd()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_get_rmsd)


            * [`MoleculeMatcherTest.test_group_molecules()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_group_molecules)


            * [`MoleculeMatcherTest.test_strange_inchi()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_strange_inchi)


            * [`MoleculeMatcherTest.test_thiane()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_thiane)


            * [`MoleculeMatcherTest.test_thiane_ethynyl()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_thiane_ethynyl)


            * [`MoleculeMatcherTest.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.MoleculeMatcherTest.test_to_and_from_dict)


        * [`generate_Si2O_cluster()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.generate_Si2O_cluster)


        * [`generate_Si_cluster()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.generate_Si_cluster)


        * [`permute()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.permute)


        * [`perturb()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.perturb)


        * [`rotate()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_matcher.rotate)


    * [pymatgen.analysis.tests.test_molecule_structure_comparator module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_molecule_structure_comparator)


        * [`TestMoleculeStructureComparator`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_structure_comparator.TestMoleculeStructureComparator)


            * [`TestMoleculeStructureComparator.test_are_equal()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_structure_comparator.TestMoleculeStructureComparator.test_are_equal)


            * [`TestMoleculeStructureComparator.test_get_13_bonds()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_structure_comparator.TestMoleculeStructureComparator.test_get_13_bonds)


            * [`TestMoleculeStructureComparator.test_get_bonds()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_structure_comparator.TestMoleculeStructureComparator.test_get_bonds)


            * [`TestMoleculeStructureComparator.test_to_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_molecule_structure_comparator.TestMoleculeStructureComparator.test_to_and_from_dict)


    * [pymatgen.analysis.tests.test_nmr module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_nmr)


        * [`TestChemicalShieldingNotation`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestChemicalShieldingNotation)


            * [`TestChemicalShieldingNotation.test_construction()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestChemicalShieldingNotation.test_construction)


            * [`TestChemicalShieldingNotation.test_notations()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestChemicalShieldingNotation.test_notations)


            * [`TestChemicalShieldingNotation.test_principal_axis_system()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestChemicalShieldingNotation.test_principal_axis_system)


        * [`TestElectricFieldGradient`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestElectricFieldGradient)


            * [`TestElectricFieldGradient.test_Attributes()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestElectricFieldGradient.test_Attributes)


            * [`TestElectricFieldGradient.test_construction()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestElectricFieldGradient.test_construction)


            * [`TestElectricFieldGradient.test_principal_axis_system()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_nmr.TestElectricFieldGradient.test_principal_axis_system)


    * [pymatgen.analysis.tests.test_path_finder module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_path_finder)


        * [`PathFinderTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_path_finder.PathFinderTest)


            * [`PathFinderTest.test_image_num()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_path_finder.PathFinderTest.test_image_num)


    * [pymatgen.analysis.tests.test_phase_diagram module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_phase_diagram)


        * [`CompoundPhaseDiagramTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.CompoundPhaseDiagramTest)


            * [`CompoundPhaseDiagramTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.CompoundPhaseDiagramTest.setUp)


            * [`CompoundPhaseDiagramTest.test_get_formation_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.CompoundPhaseDiagramTest.test_get_formation_energy)


            * [`CompoundPhaseDiagramTest.test_stable_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.CompoundPhaseDiagramTest.test_stable_entries)


            * [`CompoundPhaseDiagramTest.test_str()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.CompoundPhaseDiagramTest.test_str)


        * [`GrandPotentialPhaseDiagramTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.GrandPotentialPhaseDiagramTest)


            * [`GrandPotentialPhaseDiagramTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.GrandPotentialPhaseDiagramTest.setUp)


            * [`GrandPotentialPhaseDiagramTest.test_get_formation_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.GrandPotentialPhaseDiagramTest.test_get_formation_energy)


            * [`GrandPotentialPhaseDiagramTest.test_stable_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.GrandPotentialPhaseDiagramTest.test_stable_entries)


            * [`GrandPotentialPhaseDiagramTest.test_str()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.GrandPotentialPhaseDiagramTest.test_str)


        * [`PDEntryTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest)


            * [`PDEntryTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.setUp)


            * [`PDEntryTest.test_get_chemical_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_get_chemical_energy)


            * [`PDEntryTest.test_get_composition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_get_composition)


            * [`PDEntryTest.test_get_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_get_energy)


            * [`PDEntryTest.test_get_energy_per_atom()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_get_energy_per_atom)


            * [`PDEntryTest.test_get_name()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_get_name)


            * [`PDEntryTest.test_is_element()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_is_element)


            * [`PDEntryTest.test_read_csv()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_read_csv)


            * [`PDEntryTest.test_str()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_str)


            * [`PDEntryTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDEntryTest.test_to_from_dict)


        * [`PDPlotterTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDPlotterTest)


            * [`PDPlotterTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDPlotterTest.setUp)


            * [`PDPlotterTest.test_mpl_plots()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDPlotterTest.test_mpl_plots)


            * [`PDPlotterTest.test_pd_plot_data()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDPlotterTest.test_pd_plot_data)


            * [`PDPlotterTest.test_plot_pd_with_no_unstable()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDPlotterTest.test_plot_pd_with_no_unstable)


            * [`PDPlotterTest.test_plotly_plots()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PDPlotterTest.test_plotly_plots)


        * [`PatchedPhaseDiagramTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest)


            * [`PatchedPhaseDiagramTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.setUp)


            * [`PatchedPhaseDiagramTest.test_contains()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_contains)


            * [`PatchedPhaseDiagramTest.test_dimensionality()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_dimensionality)


            * [`PatchedPhaseDiagramTest.test_get_decomp_and_e_above_hull()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_decomp_and_e_above_hull)


            * [`PatchedPhaseDiagramTest.test_get_decomposition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_decomposition)


            * [`PatchedPhaseDiagramTest.test_get_equilibrium_reaction_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_equilibrium_reaction_energy)


            * [`PatchedPhaseDiagramTest.test_get_form_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_form_energy)


            * [`PatchedPhaseDiagramTest.test_get_hull_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_hull_energy)


            * [`PatchedPhaseDiagramTest.test_get_pd_for_entry()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_pd_for_entry)


            * [`PatchedPhaseDiagramTest.test_get_phase_separation_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_phase_separation_energy)


            * [`PatchedPhaseDiagramTest.test_get_qhull_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_qhull_entries)


            * [`PatchedPhaseDiagramTest.test_get_stable_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_get_stable_entries)


            * [`PatchedPhaseDiagramTest.test_getitem()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_getitem)


            * [`PatchedPhaseDiagramTest.test_iter()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_iter)


            * [`PatchedPhaseDiagramTest.test_len()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_len)


            * [`PatchedPhaseDiagramTest.test_raises_on_missing_terminal_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_raises_on_missing_terminal_entries)


            * [`PatchedPhaseDiagramTest.test_repr()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_repr)


            * [`PatchedPhaseDiagramTest.test_setitem_and_delitem()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_setitem_and_delitem)


            * [`PatchedPhaseDiagramTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PatchedPhaseDiagramTest.test_to_from_dict)


        * [`PhaseDiagramTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest)


            * [`PhaseDiagramTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.setUp)


            * [`PhaseDiagramTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.tearDown)


            * [`PhaseDiagramTest.test_1d_pd()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_1d_pd)


            * [`PhaseDiagramTest.test_all_entries_hulldata()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_all_entries_hulldata)


            * [`PhaseDiagramTest.test_dim1()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_dim1)


            * [`PhaseDiagramTest.test_downstream_methods_can_also_ignore_errors()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_downstream_methods_can_also_ignore_errors)


            * [`PhaseDiagramTest.test_el_refs()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_el_refs)


            * [`PhaseDiagramTest.test_get_all_chempots()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_all_chempots)


            * [`PhaseDiagramTest.test_get_composition_chempots()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_composition_chempots)


            * [`PhaseDiagramTest.test_get_critical_compositions()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_critical_compositions)


            * [`PhaseDiagramTest.test_get_critical_compositions_fractional()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_critical_compositions_fractional)


            * [`PhaseDiagramTest.test_get_decomp_and_e_above_hull_on_error()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_decomp_and_e_above_hull_on_error)


            * [`PhaseDiagramTest.test_get_decomposition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_decomposition)


            * [`PhaseDiagramTest.test_get_e_above_hull()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_e_above_hull)


            * [`PhaseDiagramTest.test_get_element_profile()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_element_profile)


            * [`PhaseDiagramTest.test_get_equilibrium_reaction_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_equilibrium_reaction_energy)


            * [`PhaseDiagramTest.test_get_formation_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_formation_energy)


            * [`PhaseDiagramTest.test_get_get_chempot_range_map()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_get_chempot_range_map)


            * [`PhaseDiagramTest.test_get_hull_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_hull_energy)


            * [`PhaseDiagramTest.test_get_hull_energy_per_atom()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_hull_energy_per_atom)


            * [`PhaseDiagramTest.test_get_phase_separation_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_phase_separation_energy)


            * [`PhaseDiagramTest.test_get_plot()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_plot)


            * [`PhaseDiagramTest.test_get_transition_chempots()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_get_transition_chempots)


            * [`PhaseDiagramTest.test_getmu_range_stability_phase()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_getmu_range_stability_phase)


            * [`PhaseDiagramTest.test_getmu_vertices_stability_phase()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_getmu_vertices_stability_phase)


            * [`PhaseDiagramTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_init)


            * [`PhaseDiagramTest.test_ordering()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_ordering)


            * [`PhaseDiagramTest.test_planar_inputs()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_planar_inputs)


            * [`PhaseDiagramTest.test_read_json()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_read_json)


            * [`PhaseDiagramTest.test_repr()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_repr)


            * [`PhaseDiagramTest.test_stable_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_stable_entries)


            * [`PhaseDiagramTest.test_str()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_str)


            * [`PhaseDiagramTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_to_from_dict)


            * [`PhaseDiagramTest.test_val_err_on_no_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.PhaseDiagramTest.test_val_err_on_no_entries)


        * [`ReactionDiagramTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.ReactionDiagramTest)


            * [`ReactionDiagramTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.ReactionDiagramTest.setUp)


            * [`ReactionDiagramTest.test_formula()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.ReactionDiagramTest.test_formula)


            * [`ReactionDiagramTest.test_get_compound_pd()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.ReactionDiagramTest.test_get_compound_pd)


        * [`TransformedPDEntryTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest)


            * [`TransformedPDEntryTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.setUp)


            * [`TransformedPDEntryTest.test_get_composition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_get_composition)


            * [`TransformedPDEntryTest.test_get_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_get_energy)


            * [`TransformedPDEntryTest.test_get_energy_per_atom()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_get_energy_per_atom)


            * [`TransformedPDEntryTest.test_get_name()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_get_name)


            * [`TransformedPDEntryTest.test_is_element()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_is_element)


            * [`TransformedPDEntryTest.test_normalize()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_normalize)


            * [`TransformedPDEntryTest.test_str()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_str)


            * [`TransformedPDEntryTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.TransformedPDEntryTest.test_to_from_dict)


        * [`UtilityFunctionTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.UtilityFunctionTest)


            * [`UtilityFunctionTest.test_tet_coord()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.UtilityFunctionTest.test_tet_coord)


            * [`UtilityFunctionTest.test_triangular_coord()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.UtilityFunctionTest.test_triangular_coord)


            * [`UtilityFunctionTest.test_unique_lines()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_phase_diagram.UtilityFunctionTest.test_unique_lines)


    * [pymatgen.analysis.tests.test_piezo module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_piezo)


        * [`PiezoTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo.PiezoTest)


            * [`PiezoTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo.PiezoTest.setUp)


            * [`PiezoTest.test_from_vasp_voigt()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo.PiezoTest.test_from_vasp_voigt)


            * [`PiezoTest.test_from_voigt()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo.PiezoTest.test_from_voigt)


            * [`PiezoTest.test_new()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo.PiezoTest.test_new)


    * [pymatgen.analysis.tests.test_piezo_sensitivity module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_piezo_sensitivity)


        * [`PiezoSensitivityTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest)


            * [`PiezoSensitivityTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.setUp)


            * [`PiezoSensitivityTest.test_BornEffectiveChargeTensor()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_BornEffectiveChargeTensor)


            * [`PiezoSensitivityTest.test_ForceConstantMatrix()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_ForceConstantMatrix)


            * [`PiezoSensitivityTest.test_InternalStrainTensor()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_InternalStrainTensor)


            * [`PiezoSensitivityTest.test_get_BEC_operations()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_BEC_operations)


            * [`PiezoSensitivityTest.test_get_FCM_operations()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_FCM_operations)


            * [`PiezoSensitivityTest.test_get_FCM_symmetry()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_FCM_symmetry)


            * [`PiezoSensitivityTest.test_get_asum_FCM()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_asum_FCM)


            * [`PiezoSensitivityTest.test_get_piezo()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_piezo)


            * [`PiezoSensitivityTest.test_get_rand_BEC()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_rand_BEC)


            * [`PiezoSensitivityTest.test_get_rand_IST()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_rand_IST)


            * [`PiezoSensitivityTest.test_get_stable_FCM()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_stable_FCM)


            * [`PiezoSensitivityTest.test_get_unstable_FCM()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_get_unstable_FCM)


            * [`PiezoSensitivityTest.test_rand_FCM()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_rand_FCM)


            * [`PiezoSensitivityTest.test_rand_piezo()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_piezo_sensitivity.PiezoSensitivityTest.test_rand_piezo)


    * [pymatgen.analysis.tests.test_pourbaix_diagram module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_pourbaix_diagram)


        * [`PourbaixDiagramTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest)


            * [`PourbaixDiagramTest.setUpClass()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.setUpClass)


            * [`PourbaixDiagramTest.test_get_decomposition()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_get_decomposition)


            * [`PourbaixDiagramTest.test_get_pourbaix_domains()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_get_pourbaix_domains)


            * [`PourbaixDiagramTest.test_get_stable_entry()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_get_stable_entry)


            * [`PourbaixDiagramTest.test_multicomponent()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_multicomponent)


            * [`PourbaixDiagramTest.test_multielement_parallel()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_multielement_parallel)


            * [`PourbaixDiagramTest.test_pourbaix_diagram()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_pourbaix_diagram)


            * [`PourbaixDiagramTest.test_properties()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_properties)


            * [`PourbaixDiagramTest.test_serialization()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_serialization)


            * [`PourbaixDiagramTest.test_solid_filter()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixDiagramTest.test_solid_filter)


        * [`PourbaixEntryTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest)


            * [`PourbaixEntryTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest.setUp)


            * [`PourbaixEntryTest.test_calc_coeff_terms()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest.test_calc_coeff_terms)


            * [`PourbaixEntryTest.test_energy_functions()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest.test_energy_functions)


            * [`PourbaixEntryTest.test_get_elt_fraction()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest.test_get_elt_fraction)


            * [`PourbaixEntryTest.test_multi_entry()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest.test_multi_entry)


            * [`PourbaixEntryTest.test_pourbaix_entry()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest.test_pourbaix_entry)


            * [`PourbaixEntryTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixEntryTest.test_to_from_dict)


        * [`PourbaixPlotterTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixPlotterTest)


            * [`PourbaixPlotterTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixPlotterTest.setUp)


            * [`PourbaixPlotterTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixPlotterTest.tearDown)


            * [`PourbaixPlotterTest.test_plot_entry_stability()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixPlotterTest.test_plot_entry_stability)


            * [`PourbaixPlotterTest.test_plot_pourbaix()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_pourbaix_diagram.PourbaixPlotterTest.test_plot_pourbaix)


    * [pymatgen.analysis.tests.test_prototypes module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_prototypes)


        * [`AflowPrototypeMatcherTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_prototypes.AflowPrototypeMatcherTest)


            * [`AflowPrototypeMatcherTest.test_prototype_matching()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_prototypes.AflowPrototypeMatcherTest.test_prototype_matching)


    * [pymatgen.analysis.tests.test_quasiharmonic_debye_approx module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_quasiharmonic_debye_approx)


        * [`TestAnharmonicQuasiharmociDebyeApprox`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox)


            * [`TestAnharmonicQuasiharmociDebyeApprox.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox.setUp)


            * [`TestAnharmonicQuasiharmociDebyeApprox.test_debye_temperature()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox.test_debye_temperature)


            * [`TestAnharmonicQuasiharmociDebyeApprox.test_gruneisen_parameter()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox.test_gruneisen_parameter)


            * [`TestAnharmonicQuasiharmociDebyeApprox.test_optimum_volume()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox.test_optimum_volume)


            * [`TestAnharmonicQuasiharmociDebyeApprox.test_thermal_conductivity()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox.test_thermal_conductivity)


            * [`TestAnharmonicQuasiharmociDebyeApprox.test_vibrational_free_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox.test_vibrational_free_energy)


            * [`TestAnharmonicQuasiharmociDebyeApprox.test_vibrational_internal_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestAnharmonicQuasiharmociDebyeApprox.test_vibrational_internal_energy)


        * [`TestQuasiharmociDebyeApprox`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox)


            * [`TestQuasiharmociDebyeApprox.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.setUp)


            * [`TestQuasiharmociDebyeApprox.test_bulk_modulus()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.test_bulk_modulus)


            * [`TestQuasiharmociDebyeApprox.test_debye_temperature()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.test_debye_temperature)


            * [`TestQuasiharmociDebyeApprox.test_gruneisen_parameter()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.test_gruneisen_parameter)


            * [`TestQuasiharmociDebyeApprox.test_optimum_volume()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.test_optimum_volume)


            * [`TestQuasiharmociDebyeApprox.test_thermal_conductivity()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.test_thermal_conductivity)


            * [`TestQuasiharmociDebyeApprox.test_vibrational_free_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.test_vibrational_free_energy)


            * [`TestQuasiharmociDebyeApprox.test_vibrational_internal_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_quasiharmonic_debye_approx.TestQuasiharmociDebyeApprox.test_vibrational_internal_energy)


    * [pymatgen.analysis.tests.test_reaction_calculator module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_reaction_calculator)


        * [`BalancedReactionTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.BalancedReactionTest)


            * [`BalancedReactionTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.BalancedReactionTest.setUp)


            * [`BalancedReactionTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.BalancedReactionTest.tearDown)


            * [`BalancedReactionTest.test_from_str()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.BalancedReactionTest.test_from_str)


            * [`BalancedReactionTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.BalancedReactionTest.test_init)


            * [`BalancedReactionTest.test_remove_spectator_species()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.BalancedReactionTest.test_remove_spectator_species)


            * [`BalancedReactionTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.BalancedReactionTest.test_to_from_dict)


        * [`ComputedReactionTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest)


            * [`ComputedReactionTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.setUp)


            * [`ComputedReactionTest.test_all_entries()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.test_all_entries)


            * [`ComputedReactionTest.test_calculated_reaction_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.test_calculated_reaction_energy)


            * [`ComputedReactionTest.test_calculated_reaction_energy_uncertainty()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.test_calculated_reaction_energy_uncertainty)


            * [`ComputedReactionTest.test_calculated_reaction_energy_uncertainty_for_nan()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.test_calculated_reaction_energy_uncertainty_for_nan)


            * [`ComputedReactionTest.test_calculated_reaction_energy_uncertainty_for_no_uncertainty()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.test_calculated_reaction_energy_uncertainty_for_no_uncertainty)


            * [`ComputedReactionTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.test_init)


            * [`ComputedReactionTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ComputedReactionTest.test_to_from_dict)


        * [`ReactionTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest)


            * [`ReactionTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.setUp)


            * [`ReactionTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.tearDown)


            * [`ReactionTest.test_as_entry()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_as_entry)


            * [`ReactionTest.test_calculate_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_calculate_energy)


            * [`ReactionTest.test_equals()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_equals)


            * [`ReactionTest.test_init()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_init)


            * [`ReactionTest.test_normalize_to()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_normalize_to)


            * [`ReactionTest.test_overdetermined()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_overdetermined)


            * [`ReactionTest.test_products_reactants()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_products_reactants)


            * [`ReactionTest.test_rank()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_rank)


            * [`ReactionTest.test_scientific_notation()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_scientific_notation)


            * [`ReactionTest.test_singular_case()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_singular_case)


            * [`ReactionTest.test_to_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_to_from_dict)


            * [`ReactionTest.test_underdetermined()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_underdetermined)


            * [`ReactionTest.test_underdetermined_reactants()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_reaction_calculator.ReactionTest.test_underdetermined_reactants)


    * [pymatgen.analysis.tests.test_structure_analyzer module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_structure_analyzer)


        * [`MiscFunctionTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.MiscFunctionTest)


            * [`MiscFunctionTest.test_average_coordination_number()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.MiscFunctionTest.test_average_coordination_number)


            * [`MiscFunctionTest.test_contains_peroxide()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.MiscFunctionTest.test_contains_peroxide)


            * [`MiscFunctionTest.test_oxide_type()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.MiscFunctionTest.test_oxide_type)


            * [`MiscFunctionTest.test_solid_angle()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.MiscFunctionTest.test_solid_angle)


            * [`MiscFunctionTest.test_sulfide_type()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.MiscFunctionTest.test_sulfide_type)


        * [`RelaxationAnalyzerTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.RelaxationAnalyzerTest)


            * [`RelaxationAnalyzerTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.RelaxationAnalyzerTest.setUp)


            * [`RelaxationAnalyzerTest.test_get_percentage_bond_dist_changes()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.RelaxationAnalyzerTest.test_get_percentage_bond_dist_changes)


            * [`RelaxationAnalyzerTest.test_vol_and_para_changes()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.RelaxationAnalyzerTest.test_vol_and_para_changes)


        * [`VoronoiAnalyzerTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.VoronoiAnalyzerTest)


            * [`VoronoiAnalyzerTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.VoronoiAnalyzerTest.setUp)


            * [`VoronoiAnalyzerTest.test_analyze()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.VoronoiAnalyzerTest.test_analyze)


        * [`VoronoiConnectivityTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.VoronoiConnectivityTest)


            * [`VoronoiConnectivityTest.test_connectivity_array()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_analyzer.VoronoiConnectivityTest.test_connectivity_array)


    * [pymatgen.analysis.tests.test_structure_matcher module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_structure_matcher)


        * [`StructureMatcherTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest)


            * [`StructureMatcherTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.setUp)


            * [`StructureMatcherTest.test_as_dict_and_from_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_as_dict_and_from_dict)


            * [`StructureMatcherTest.test_cart_dists()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_cart_dists)


            * [`StructureMatcherTest.test_class()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_class)


            * [`StructureMatcherTest.test_cmp_fstruct()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_cmp_fstruct)


            * [`StructureMatcherTest.test_disordered_primitive_to_ordered_supercell()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_disordered_primitive_to_ordered_supercell)


            * [`StructureMatcherTest.test_disordered_to_disordered()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_disordered_to_disordered)


            * [`StructureMatcherTest.test_electronegativity()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_electronegativity)


            * [`StructureMatcherTest.test_find_match1()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_find_match1)


            * [`StructureMatcherTest.test_find_match2()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_find_match2)


            * [`StructureMatcherTest.test_fit()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_fit)


            * [`StructureMatcherTest.test_get_lattices()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_get_lattices)


            * [`StructureMatcherTest.test_get_mapping()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_get_mapping)


            * [`StructureMatcherTest.test_get_mask()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_get_mask)


            * [`StructureMatcherTest.test_get_s2_large_s2()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_get_s2_large_s2)


            * [`StructureMatcherTest.test_get_supercell_matrix()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_get_supercell_matrix)


            * [`StructureMatcherTest.test_get_supercell_size()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_get_supercell_size)


            * [`StructureMatcherTest.test_get_supercells()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_get_supercells)


            * [`StructureMatcherTest.test_ignore_species()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_ignore_species)


            * [`StructureMatcherTest.test_left_handed_lattice()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_left_handed_lattice)


            * [`StructureMatcherTest.test_mix()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_mix)


            * [`StructureMatcherTest.test_no_scaling()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_no_scaling)


            * [`StructureMatcherTest.test_occupancy_comparator()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_occupancy_comparator)


            * [`StructureMatcherTest.test_ordered_primitive_to_disordered_supercell()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_ordered_primitive_to_disordered_supercell)


            * [`StructureMatcherTest.test_out_of_cell_s2_like_s1()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_out_of_cell_s2_like_s1)


            * [`StructureMatcherTest.test_oxi()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_oxi)


            * [`StructureMatcherTest.test_primitive()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_primitive)


            * [`StructureMatcherTest.test_rms_vs_minimax()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_rms_vs_minimax)


            * [`StructureMatcherTest.test_subset()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_subset)


            * [`StructureMatcherTest.test_supercell_fit()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_supercell_fit)


            * [`StructureMatcherTest.test_supercell_subsets()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_structure_matcher.StructureMatcherTest.test_supercell_subsets)


    * [pymatgen.analysis.tests.test_surface_analysis module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_surface_analysis)


        * [`NanoscaleStabilityTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.NanoscaleStabilityTest)


            * [`NanoscaleStabilityTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.NanoscaleStabilityTest.setUp)


            * [`NanoscaleStabilityTest.test_scaled_wulff()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.NanoscaleStabilityTest.test_scaled_wulff)


            * [`NanoscaleStabilityTest.test_stability_at_r()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.NanoscaleStabilityTest.test_stability_at_r)


        * [`SlabEntryTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SlabEntryTest)


            * [`SlabEntryTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SlabEntryTest.setUp)


            * [`SlabEntryTest.test_cleaned_up_slab()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SlabEntryTest.test_cleaned_up_slab)


            * [`SlabEntryTest.test_create_slab_label()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SlabEntryTest.test_create_slab_label)


            * [`SlabEntryTest.test_properties()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SlabEntryTest.test_properties)


            * [`SlabEntryTest.test_surface_energy()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SlabEntryTest.test_surface_energy)


        * [`SurfaceEnergyPlotterTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest)


            * [`SurfaceEnergyPlotterTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest.setUp)


            * [`SurfaceEnergyPlotterTest.test_color_palette_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest.test_color_palette_dict)


            * [`SurfaceEnergyPlotterTest.test_entry_dict_from_list()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest.test_entry_dict_from_list)


            * [`SurfaceEnergyPlotterTest.test_get_stable_entry_at_u()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest.test_get_stable_entry_at_u)


            * [`SurfaceEnergyPlotterTest.test_get_surface_equilibrium()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest.test_get_surface_equilibrium)


            * [`SurfaceEnergyPlotterTest.test_stable_u_range_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest.test_stable_u_range_dict)


            * [`SurfaceEnergyPlotterTest.test_wulff_from_chempot()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.SurfaceEnergyPlotterTest.test_wulff_from_chempot)


        * [`WorkfunctionAnalyzerTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.WorkfunctionAnalyzerTest)


            * [`WorkfunctionAnalyzerTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.WorkfunctionAnalyzerTest.setUp)


            * [`WorkfunctionAnalyzerTest.test_is_converged()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.WorkfunctionAnalyzerTest.test_is_converged)


            * [`WorkfunctionAnalyzerTest.test_shift()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.WorkfunctionAnalyzerTest.test_shift)


        * [`get_entry_dict()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.get_entry_dict)


        * [`get_path()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.get_path)


        * [`load_O_adsorption()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_surface_analysis.load_O_adsorption)


    * [pymatgen.analysis.tests.test_transition_state module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_transition_state)


        * [`NEBAnalysisTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_transition_state.NEBAnalysisTest)


            * [`NEBAnalysisTest.runTest()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_transition_state.NEBAnalysisTest.runTest)


            * [`NEBAnalysisTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_transition_state.NEBAnalysisTest.setUp)


            * [`NEBAnalysisTest.tearDown()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_transition_state.NEBAnalysisTest.tearDown)


            * [`NEBAnalysisTest.test_combine_neb_plots()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_transition_state.NEBAnalysisTest.test_combine_neb_plots)


    * [pymatgen.analysis.tests.test_wulff module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_wulff)


        * [`WulffShapeTest`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest)


            * [`WulffShapeTest.consistency_tests()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.consistency_tests)


            * [`WulffShapeTest.setUp()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.setUp)


            * [`WulffShapeTest.symm_check()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.symm_check)


            * [`WulffShapeTest.symmetry_test()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.symmetry_test)


            * [`WulffShapeTest.test_corner_and_edges()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.test_corner_and_edges)


            * [`WulffShapeTest.test_get_azimuth_elev()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.test_get_azimuth_elev)


            * [`WulffShapeTest.test_get_plot()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.test_get_plot)


            * [`WulffShapeTest.test_get_plotly()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.test_get_plotly)


            * [`WulffShapeTest.test_properties()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_wulff.WulffShapeTest.test_properties)


    * [pymatgen.analysis.tests.test_xps module](pymatgen.analysis.tests.md#module-pymatgen.analysis.tests.test_xps)


        * [`XPSTestCase`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_xps.XPSTestCase)


            * [`XPSTestCase.test_from_dos()`](pymatgen.analysis.tests.md#pymatgen.analysis.tests.test_xps.XPSTestCase.test_from_dos)


* [pymatgen.analysis.topological package](pymatgen.analysis.topological.md)


    * [Subpackages](pymatgen.analysis.topological.md#subpackages)
...
* [pymatgen.analysis.xas package](pymatgen.analysis.xas.md)
    ...
    * [Subpackages](pymatgen.analysis.xas.md#subpackages)
...
### _class_ pymatgen.analysis.chempot_diagram.ChemicalPotentialDiagram(entries: list[PDEntry], limits: dict[[Element](pymatgen.core.md#pymatgen.core.periodic_table.Element), tuple[float, float]] | None = None, default_min_limit: float = -50.0, formal_chempots: bool = True)
Bases: `MSONable`
...
#### _property_ el_refs(_: dict[[pymatgen.core.periodic_table.Element](pymatgen.core.md#pymatgen.core.periodic_table.Element), pymatgen.analysis.phase_diagram.PDEntry_ )
...
#### _property_ hyperplane_entries(_: list[pymatgen.analysis.phase_diagram.PDEntry_ )
...
### pymatgen.analysis.disorder.get_warren_cowley_parameters(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), r: float, dr: float)
...
### _class_ pymatgen.analysis.graphs.StructureGraph(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), graph_data=None)
Bases: `MSONable`
...
#### _classmethod_ with_empty_graph(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), name='bonds', edge_weight_name=None, edge_weight_units=None)
...
### _class_ pymatgen.analysis.interface_reactions.GrandPotentialInterfacialReactivity(c1: [Composition](pymatgen.core.md#pymatgen.core.composition.Composition), c2: [Composition](pymatgen.core.md#pymatgen.core.composition.Composition), grand_pd: GrandPotentialPhaseDiagram, pd_non_grand: PhaseDiagram, include_no_mixing_energy: bool = False, norm: bool = True, use_hull_energy: bool = True)
...
### _class_ pymatgen.analysis.interface_reactions.InterfacialReactivity(c1: [Composition](pymatgen.core.md#pymatgen.core.composition.Composition), c2: [Composition](pymatgen.core.md#pymatgen.core.composition.Composition), pd: PhaseDiagram, norm: bool = True, use_hull_energy: bool = False, \*\*kwargs)
Bases: `MSONable`
...
### _class_ pymatgen.analysis.local_env.IsayevNN(tol: float = 0.25, targets: [Element](pymatgen.core.md#pymatgen.core.periodic_table.Element) | list[[Element](pymatgen.core.md#pymatgen.core.periodic_table.Element)] | None = None, cutoff: float = 13.0, allow_pathological: bool = False, extra_nn_info: bool = True, compute_adj_neighbors: bool = True)
Bases: `VoronoiNN`
...
### _class_ pymatgen.analysis.local_env.ValenceIonicRadiusEvaluator(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure))
Bases: `object`
...
### pymatgen.analysis.local_env.oxygen_edge_extender(mol_graph: MoleculeGraph)
...
### _class_ pymatgen.analysis.molecule_matcher.BruteForceOrderMatcher(target: [Molecule](pymatgen.core.md#pymatgen.core.structure.Molecule))
Bases: `KabschMatcher`
...
### _class_ pymatgen.analysis.molecule_matcher.GeneticOrderMatcher(target: [Molecule](pymatgen.core.md#pymatgen.core.structure.Molecule), threshold: float)
Bases: `KabschMatcher`
...
### _class_ pymatgen.analysis.molecule_matcher.HungarianOrderMatcher(target: [Molecule](pymatgen.core.md#pymatgen.core.structure.Molecule))
Bases: `KabschMatcher`
...
### _class_ pymatgen.analysis.molecule_matcher.KabschMatcher(target: [Molecule](pymatgen.core.md#pymatgen.core.structure.Molecule))
Bases: `MSONable`
...
### _class_ pymatgen.analysis.phase_diagram.PDEntry(composition: [Composition](pymatgen.core.md#pymatgen.core.composition.Composition), energy: float, name: str | None = None, attribute: object = None)
...
### _class_ pymatgen.analysis.phase_diagram.PatchedPhaseDiagram(entries: Sequence[PDEntry] | set[PDEntry], elements: Sequence[[Element](pymatgen.core.md#pymatgen.core.periodic_table.Element)] | None = None, keep_all_spaces: bool = False, verbose: bool = False)
Bases: `PhaseDiagram`
...
### _class_ pymatgen.analysis.phase_diagram.PhaseDiagram(entries: Sequence[PDEntry] | set[PDEntry], elements: Sequence[[Element](pymatgen.core.md#pymatgen.core.periodic_table.Element)] = (), \*, computed_data: dict[str, Any] | None = None)
Bases: `MSONable`
...
### _class_ pymatgen.analysis.piezo_sensitivity.BornEffectiveCharge(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), bec, pointops, tol: float = 0.001)
Bases: `object`
...
### _class_ pymatgen.analysis.piezo_sensitivity.ForceConstantMatrix(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), fcm, pointops, sharedops, tol: float = 0.001)
Bases: `object`
...
### _class_ pymatgen.analysis.piezo_sensitivity.InternalStrainTensor(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), ist, pointops, tol: float = 0.001)
Bases: `object`
...
### _class_ pymatgen.analysis.structure_analyzer.OxideType(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), relative_cutoff=1.1)
Bases: `object`
...
### _class_ pymatgen.analysis.structure_analyzer.VoronoiConnectivity(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), cutoff=10)
Bases: `object`
...
### pymatgen.analysis.structure_analyzer.oxide_type(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), relative_cutoff: float = 1.1, return_nbonds: bool = False)
Determines if an oxide is a peroxide/superoxide/ozonide/normal oxide.
...
### _class_ pymatgen.analysis.surface_analysis.WorkFunctionAnalyzer(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), locpot_along_c, efermi, shift=0, blength=3.5)
Bases: `object`
...
### _class_ pymatgen.analysis.wulff.WulffShape(lattice: [Lattice](pymatgen.core.md#pymatgen.core.lattice.Lattice), miller_list, e_surf_list, symprec=1e-05)
Bases: `object`
