...
### _class_ pymatgen.io.vasp.outputs.VolumetricData(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), data, distance_matrix=None, data_aug=None)
...
* **Parameters**
    ...
    * **structure** ([*Structure*](pymatgen.core.md#pymatgen.core.structure.Structure)) – The Structure to create inputs for.
    ...
    * **user_kpoints_settings** (*dict** or *[*Kpoints*](pymatgen.io.cp2k.md#pymatgen.io.cp2k.inputs.Kpoints)) – Allow user to override kpoints
...
### _class_ pymatgen.io.vasp.sets.LobsterSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), isym: int = 0, ismear: int = -5, reciprocal_density: int | None = None, address_basis_file: str | None = None, user_supplied_basis: dict | None = None, \*\*kwargs)
Bases: `MPRelaxSet`
...
### _class_ pymatgen.io.vasp.sets.MITMDSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), start_temp, end_temp, nsteps, time_step=2, spin_polarized=False, \*\*kwargs)
Bases: `MITRelaxSet`
...
### _class_ pymatgen.io.vasp.sets.MITRelaxSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), \*\*kwargs)
Bases: `DictSet`
...
### _class_ pymatgen.io.vasp.sets.MPHSERelaxSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), \*\*kwargs)
Bases: `DictSet`
...
### _class_ pymatgen.io.vasp.sets.MPMDSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), start_temp, end_temp, nsteps, spin_polarized=False, \*\*kwargs)
Bases: `MPRelaxSet`
...
### _class_ pymatgen.io.vasp.sets.MPMetalRelaxSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), \*\*kwargs)
Bases: `MPRelaxSet`
...
### _class_ pymatgen.io.vasp.sets.MPNMRSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), mode: Literal['cs', 'efg'] = 'cs', isotopes: list | None = None, prev_incar: Incar = None, reciprocal_density: int = 100, \*\*kwargs)
Bases: `MPStaticSet`
...
### _class_ pymatgen.io.vasp.sets.MPRelaxSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), \*\*kwargs)
Bases: `DictSet`
...
### _class_ pymatgen.io.vasp.sets.MPScanRelaxSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), bandgap=0, \*\*kwargs)
Bases: `DictSet`
...
### _class_ pymatgen.io.vasp.sets.MPScanStaticSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), bandgap=0, prev_incar=None, lepsilon=False, lcalcpol=False, \*\*kwargs)
...
### _class_ pymatgen.io.vasp.sets.MVLElasticSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), potim: float = 0.015, \*\*kwargs)
Bases: `MPRelaxSet`
...
### _class_ pymatgen.io.vasp.sets.MVLGBSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), k_product=40, slab_mode=False, is_metal=True, \*\*kwargs)
Bases: `MPRelaxSet`
...
### _class_ pymatgen.io.vasp.sets.MVLNPTMDSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), start_temp, end_temp, nsteps, time_step=2, spin_polarized=False, \*\*kwargs)
Bases: `MITMDSet`
...
### _class_ pymatgen.io.vasp.sets.MVLRelax52Set(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), \*\*kwargs)
Bases: `DictSet`
...
### _class_ pymatgen.io.vasp.sets.MVLScanRelaxSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), \*\*kwargs)
Bases: `MPRelaxSet`
...
### _class_ pymatgen.io.vasp.sets.MVLSlabSet(structure: [Structure](pymatgen.core.md#pymatgen.core.structure.Structure), k_product=50, bulk=False, auto_dipole=False, set_mix=True, sort_structure=True, \*\*kwargs)
Bases: `MPRelaxSet`
