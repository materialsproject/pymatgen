...
### pymatgen.analysis.chemenv.utils.coordination_geometry_utils.quarter_ellipsis_functions(xx: ArrayLike, yy: ArrayLike)
...
### pymatgen.analysis.chemenv.utils.coordination_geometry_utils.solid_angle(center, coords)
