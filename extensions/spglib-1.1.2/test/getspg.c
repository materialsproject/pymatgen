...
VALUE method_refine_cell(VALUE self, VALUE r_size, VALUE r_lattice, VALUE r_position, VALUE r_types, VALUE r_symprec);
VALUE method_get_operations(VALUE self, VALUE r_size, VALUE r_lattice, VALUE r_position, VALUE r_types, VALUE r_symprec);
VALUE method_get_dataset(VALUE self, VALUE r_lattice, VALUE r_position, VALUE r_types, VALUE r_symprec);
...
void Init_getspg(void)
{
  ...
  rb_define_method(Getspg, "refine_cell", method_refine_cell, 5);
  rb_define_method(Getspg, "get_operations", method_get_operations, 5);
  rb_define_method(Getspg, "get_dataset", method_get_dataset, 4);
}
...
VALUE method_getspg(VALUE self, VALUE r_size, VALUE r_lattice, VALUE r_position, VALUE r_types, VALUE r_symprec)
{
  ...
  /* Space group */
  spgroup = spg_get_international( symbol,
				   lattice,
				   position,
				   types,
				   size,
...
VALUE method_get_operations(VALUE self, VALUE r_size, VALUE r_lattice, VALUE r_position, VALUE r_types, VALUE r_symprec)
{
  ...
  num_sym = spg_get_symmetry( rotation,
			      translation,
			      num_atom*192,
			      lattice,
			      position,
