...
if __name__ == "__main__":
    ...
    , plotting and format conversions.''',
    epilog="""
    ...
    parser_vasp = subparsers.add_parser('analyze', help="Analysis tools. Do"
                                        " vasper.py analyze -h for subcommand"
                                        " help.")
    ...
    parser_plot = subparsers.add_parser('plot', help="Plotting tools. Do"
